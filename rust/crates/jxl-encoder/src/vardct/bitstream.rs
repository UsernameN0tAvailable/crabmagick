...
impl VarDctEncoder {
    ...
    fn encode_two_pass_to_writer(
        ...
        #[cfg(feature = "parallel")]
        let built_codes = if !crate::parallel::sequential_maps_forced() {
            crate::parallel::parallel_map(num_entropy_code_jobs, |job_idx| {
                crate::parallel::with_sequential_maps(|| build_entropy_code_job(job_idx))
            })
        } else {
        ...
        if num_groups == 1 && num_dc_groups == 1 && num_passes == 1 {
            ...
            if crate::parallel::sequential_maps_forced() {
                ...
                let dc_group_sections: Vec<Vec<u8>> =
                    crate::parallel::parallel_map_result(num_dc_groups, encode_dc_group)?;
            ...
            for pass in 0..num_passes {
                ...
                if crate::parallel::sequential_maps_forced() {
                    ...
                    let ac_group_sections: Vec<Vec<u8>> =
                        crate::parallel::parallel_map_result(num_groups, encode_ac_group)?;
