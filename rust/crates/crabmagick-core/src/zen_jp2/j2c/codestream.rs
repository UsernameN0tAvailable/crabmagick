...
use crate::zen_jp2::error::{MarkerError, Result, ValidationError, bail, err};
...
fn size_marker(reader: &mut BitReader<'_>) -> Result<SizeData> {
    ...
    {
        bail!(crate::zen_jp2::TileError::InvalidOffsets);
    }
    ...
    if size_data
        ...
        .ok_or(crate::zen_jp2::TileError::InvalidOffsets)?
