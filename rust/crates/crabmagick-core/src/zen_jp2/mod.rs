...
`zen-jp2` can decode both raw JPEG 2000 codestreams (`.j2c`) and images wrapped
...
# Example
```rust,no_run
use zen_jp2::{DecodeSettings, DecoderContext, Image};
...
use crate::zen_jp2::error::{bail, err};
use crate::zen_jp2::j2c::Header;
use crate::zen_jp2::jp2::ImageBoxes;
use crate::zen_jp2::jp2::cdef::{ChannelAssociation, ChannelType};
use crate::zen_jp2::jp2::cmap::ComponentMappingType;
use crate::zen_jp2::jp2::colr::{CieLab, EnumeratedColorspace};
...
use crate::zen_jp2::math::{Level, SIMD_WIDTH, Simd, dispatch, f32x8};
...
pub struct Bitmap {
    ...
    /// zen-jp2 always scales to 8-bit).
    ///
...
fn get_color_space(boxes: &ImageBoxes, num_components: usize) -> Result<ColorSpace> {
        ...
        .unwrap_or(&jp2::colr::ColorSpace::Unknown)
    {
        ...
        jp2::colr::ColorSpace::Icc(icc) => match crate::zen_jp2::jp2::icc::ICCMetadata::from_data(icc)
