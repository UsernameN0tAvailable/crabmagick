...
impl VarDctEncoder {
    ...
    pub(crate) fn transform_blocks_into(
        ...
        let mut dct_scratch: [Vec<f32>; 3] =
            core::array::from_fn(|_| crate::jxl_encoder_simd::vec_f32_dirty(scratch_block_size));
    ...
    pub(crate) fn transform_and_quantize(
        ...
        let group_results = crate::jxl_encoder::parallel::parallel_map(num_groups, |group_idx| {
