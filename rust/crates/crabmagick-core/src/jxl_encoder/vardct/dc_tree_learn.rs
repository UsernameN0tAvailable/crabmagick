...
fn estimate_bits(counts: &[u32], total: u32) -> f64 {
    ...
    for &count in counts {
        if count > 0 {
            ...
            bits -= (count as f64) * crate::jxl_encoder_simd::fast_log2f(p as f32) as f64;
        }
    }
    bits
}
...
mod debug_tests {
    ...
    use crate::jxl_encoder::vardct::context_tree::{write_context_tree, write_learned_context_tree};

    #[test]
    fn test_static_tokens_through_learned_path() {
        use crate::jxl_encoder::vardct::common::pack_signed;
        use crate::jxl_encoder::vardct::context_tree::CONTEXT_TREE_TOKENS;
        let num_dc_groups = 1;
