...
use super::*;
use crate::jxl_encoder::entropy_coding::token;
...
fn test_tiny_encoder_decode() {
    ...
    crate::jxl_encoder::test_helpers::save_test_output("tiny", "test_16x16.jxl", &encoded);
...
fn test_lz77_rle_roundtrip() {
    ...
    enc_lz77.lz77_method = crate::jxl_encoder::entropy_coding::lz77::Lz77Method::Rle; // Explicit RLE for roundtrip test
...
fn test_lz77_backref_roundtrip() {
    ...
    enc_lz77.optimize_codes = true;
    enc_lz77.enable_lz77 = true;
    enc_lz77.lz77_method = crate::jxl_encoder::entropy_coding::lz77::Lz77Method::Greedy;
    #[cfg(feature = "butteraugli-loop")]
    {
...
fn test_dct32x16_16x32_roundtrip() {
    ...
    // Save for inspection
    crate::jxl_encoder::test_helpers::save_test_output("tiny", "test_dct32x16_64x64.jxl", &encoded);
...
fn test_afv_strategy_roundtrip() {
    ...
    for afv_kind in 0..4 {
        ...
        // Save for inspection
        crate::jxl_encoder::test_helpers::save_test_output(
            "tiny",
...
fn test_dct64x64_forced_decode() {
    ...
    crate::jxl_encoder::test_helpers::save_test_output("tiny", "test_dct64x64_128x128.jxl", &encoded);
