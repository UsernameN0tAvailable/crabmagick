...
fn compute_pre_erosion(
    ...
    crate::jxl_encoder_simd::compute_pre_erosion(xyb_y, width, height, tile_x0, tile_y0, tile_x1, tile_y1)
}
...
pub fn compute_mask1x1(xyb_y: &[f32], width: usize, height: usize) -> Vec<f32> {
    ...
    crate::jxl_encoder_simd::compute_mask1x1(xyb_y, width, height, &mut mask1x1);
            ...
            (0..num_strips).into_par_iter().for_each(|si| {
                ...
                STRIP_BUF.with(|strip_cell| {
                    ...
                    SCRATCH_BUF.with(|scratch_cell| {
                        ...
                        crate::jxl_encoder_simd::gaborish_5x5_channel(
                            &mut strip[..ext_size],
...
// symmetric5_blur_mask1x1 replaced by crate::jxl_encoder_simd::gaborish_5x5_channel with
...
fn per_block_modulations(
    ...
    crate::jxl_encoder_simd::per_block_modulations(
        xyb_x,
        xyb_y,
        xyb_b,
        stride,
...
pub fn compute_quant_field_float(
    ...
    // only to aq_map[0..chunk_h*aq_map_w], so disjoint chunks are safe.
    {
        ...
        crate::jxl_encoder::parallel::parallel_chunks_mut(&mut aq_map, aq_map_w * CHUNK_ROWS, |ci, chunk| {
...
mod tests {
    ...
    // compute_mask) migrated to crate::jxl_encoder_simd::adaptive_quant::tests.
