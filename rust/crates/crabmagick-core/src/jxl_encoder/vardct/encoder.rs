...
use crate::jxl_encoder::headers::frame_header::FrameHeader;
...
pub struct VarDctEncoder {
    ...
    pub lz77_method: crate::jxl_encoder::entropy_coding::lz77::Lz77Method,
    ...
    pub splines: Option<Vec<crate::jxl_encoder::vardct::splines::Spline>>,
    ...
    pub progressive: crate::jxl_encoder::api::ProgressiveMode,
    ...
    pub color_encoding: Option<crate::jxl_encoder::headers::color_encoding::ColorEncoding>,
...
impl Default for VarDctEncoder {
    fn default() -> Self {
        Self {
            distance: 1.0,
            effort: 7,
            profile: crate::jxl_encoder::effort::EffortProfile::lossy(7, crate::jxl_encoder::api::EncoderMode::Reference),
            optimize_codes: true,
            ...
            lz77_method: crate::jxl_encoder::entropy_coding::lz77::Lz77Method::Greedy, // Best compression
            ...
            splines: None,
            is_grayscale: false,
            progressive: crate::jxl_encoder::api::ProgressiveMode::Single,
            use_lf_frame: false,
            source_gamma: None,
            color_encoding: None,
...
impl VarDctEncoder {
    ...
    pub fn encode(
        ...
        crate::jxl_encoder::debug_rect::clear();
    ...
    pub fn encode_rgb8_srgb(
        ...
        {
            let linear_rgb = crate::jxl_encoder::api::srgb_u8_to_linear_f32_for_vardct(rgb, 3);
        ...
        )))]
        {
            ...
            let (xyb_x, xyb_y, xyb_b) = {
                let _trace = crate::jxl_encoder::bench_trace_enabled();
    ...
    fn encode_xyb_padded(
        ...
        if matches!(self.encoder_mode, crate::jxl_encoder::api::EncoderMode::Experimental)
        ...
        if self.optimize_codes {
            ...
            crate::jxl_encoder::debug_rect::flush("");
