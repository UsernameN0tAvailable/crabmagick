...
use super::constants::*;
use crate::jxl_encoder::vardct::common::{as_array_mut, as_array_ref};
...
pub fn idct_32x32(input: &[f32; 1024], output: &mut [f32; 1024]) {
    crate::jxl_encoder_simd::idct_32x32(input, output);
}
...
pub fn idct_32x16(input: &[f32; 512], output: &mut [f32; 512]) {
    crate::jxl_encoder_simd::idct_32x16(input, output);
}
...
pub fn idct_16x32(input: &[f32; 512], output: &mut [f32; 512]) {
    crate::jxl_encoder_simd::idct_16x32(input, output);
}
...
pub fn idct_64x64(input: &[f32], output: &mut [f32]) {
    ...
    crate::jxl_encoder_simd::idct_64x64(as_array_ref(input, 0), as_array_mut(output, 0));
}
...
pub fn idct_64x32(input: &[f32], output: &mut [f32]) {
    ...
    crate::jxl_encoder_simd::idct_64x32(as_array_ref(input, 0), as_array_mut(output, 0));
}
...
pub fn idct_32x64(input: &[f32], output: &mut [f32]) {
    ...
    crate::jxl_encoder_simd::idct_32x64(as_array_ref(input, 0), as_array_mut(output, 0));
}
...
pub fn idct_4x8_full(input: &[f32; 64], output: &mut [f32; 64]) {
    crate::jxl_encoder_simd::idct_4x8_full(input, output);
}
...
pub fn idct_8x4_full(input: &[f32; 64], output: &mut [f32; 64]) {
    crate::jxl_encoder_simd::idct_8x4_full(input, output);
}
...
pub fn idct_4x4_full(input: &[f32; 64], output: &mut [f32; 64]) {
    crate::jxl_encoder_simd::idct_4x4_full(input, output);
}
