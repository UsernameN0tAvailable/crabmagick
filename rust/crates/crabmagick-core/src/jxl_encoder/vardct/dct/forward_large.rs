...
pub fn dct_32x32(input: &[f32; 1024], output: &mut [f32; 1024]) {
    crate::jxl_encoder_simd::dct_32x32(input, output);
}
...
pub fn dct_32x16(input: &[f32; 512], output: &mut [f32; 512]) {
    crate::jxl_encoder_simd::dct_32x16(input, output);
}
...
pub fn dct_16x32(input: &[f32; 512], output: &mut [f32; 512]) {
    crate::jxl_encoder_simd::dct_16x32(input, output);
}
...
pub fn dct_64x64(input: &[f32], output: &mut [f32]) {
    ...
    crate::jxl_encoder_simd::dct_64x64(as_array_ref(input, 0), as_array_mut(output, 0));
}
...
pub fn dct_64x32(input: &[f32], output: &mut [f32]) {
    ...
    crate::jxl_encoder_simd::dct_64x32(as_array_ref(input, 0), as_array_mut(output, 0));
}
...
pub fn dct_32x64(input: &[f32], output: &mut [f32]) {
    ...
    crate::jxl_encoder_simd::dct_32x64(as_array_ref(input, 0), as_array_mut(output, 0));
}
