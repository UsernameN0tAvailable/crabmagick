...
fn convert_to_xyb_padded(
    ...
    let mut row_r = crate::jxl_encoder_simd::vec_f32_dirty(width);
    let mut row_g = crate::jxl_encoder_simd::vec_f32_dirty(width);
    let mut row_b = crate::jxl_encoder_simd::vec_f32_dirty(width);
