...
fn find_best_multiplier(
    ...
    if use_newton {
        crate::jxl_encoder_simd::cfl_find_best_multiplier_newton(
            values_m,
            values_s,
            num,
            base,
        ...
        crate::jxl_encoder_simd::cfl_find_best_multiplier(values_m, values_s, num, base, distance_mul)
    }
}
...
pub fn compute_cfl_map(
    ...
    if crate::jxl_encoder::parallel::sequential_maps_forced() {
        ...
        let tile_results = crate::jxl_encoder::parallel::parallel_map(num_tiles, compute_tile);
