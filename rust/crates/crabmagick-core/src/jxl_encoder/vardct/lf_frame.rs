...
use crate::jxl_encoder::f16::f16_roundtrip;
...
pub(crate) fn encode_lf_frame(
    ...
    let mut profile =
        crate::jxl_encoder::effort::EffortProfile::lossless(lf_effort, crate::jxl_encoder::api::EncoderMode::Reference);
    ...
    let num_groups_x = xsize_blocks.div_ceil(crate::jxl_encoder::GROUP_DIM);
    let num_groups_y = ysize_blocks.div_ceil(crate::jxl_encoder::GROUP_DIM);
    ...
    if num_groups == 1 {
        ...
        let lossy_opts = crate::jxl_encoder::modular::encode::LossyModularOptions {
            distance: main_distance,
        };

        crate::jxl_encoder::modular::encode::write_modular_stream_with_tree_dc_quant(
            &image,
            &mut section_writer,
            &profile,
...
fn encode_lf_frame_multi_group(
    ...
    use crate::jxl_encoder::modular::encode::write_group_modular_section_idx;
    use crate::jxl_encoder::modular::section::{
    ...
    let lf_group_dim = crate::jxl_encoder::GROUP_DIM * 8;
    ...
    for group_idx in 0..num_groups {
        ...
        let x_start = gx * crate::jxl_encoder::GROUP_DIM;
        let y_start = gy * crate::jxl_encoder::GROUP_DIM;
        let x_end = (x_start + crate::jxl_encoder::GROUP_DIM).min(xsize_blocks);
        let y_end = (y_start + crate::jxl_encoder::GROUP_DIM).min(ysize_blocks);
