...
use crate::jxl_encoder::api::EncoderMode;
...
impl EffortProfile {
    ...
    fn lossy_reference(effort: u8) -> Self {
        ...
        Self {
            ...
            cfl_newton: effort >= 7,
            cfl_newton_eps: crate::jxl_encoder_simd::NEWTON_EPS_DEFAULT,
            cfl_newton_max_iters: crate::jxl_encoder_simd::NEWTON_MAX_ITERS_DEFAULT,
...
///
/// Apply via [`crate::jxl_encoder::api::LossyConfig::with_internal_params`]. Fields are
...
///
/// Apply via [`crate::jxl_encoder::api::LosslessConfig::with_internal_params`]. Fields
