...
use crate::jxl_encoder::entropy_coding::huffman_tree::{build_and_store_huffman_tree, create_huffman_tree};
...
pub(crate) fn write_sparse_lz77_histogram(
    ...
    crate::jxl_encoder::trace::debug_eprintln!("SPARSE_HIST: Writing LZ77-enabled histogram");
    ...
    crate::jxl_encoder::trace::debug_eprintln!("SPARSE_HIST: {} used symbols", _num_used);
