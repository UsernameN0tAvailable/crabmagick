...
impl TreeLearningParams {
    ...
    pub fn from_profile(profile: &crate::jxl_encoder::effort::EffortProfile) -> Self {
    ...
    pub fn from_profile_squeeze(profile: &crate::jxl_encoder::effort::EffortProfile) -> Self {
        Self::from_profile_impl(profile, true)
    }

    fn from_profile_impl(profile: &crate::jxl_encoder::effort::EffortProfile, is_squeeze: bool) -> Self {
...
pub fn gather_samples_strided(
    ...
    if !crate::jxl_encoder::parallel::sequential_maps_forced() && image.channels.len() > 1 {
        ...
        let per_channel = crate::jxl_encoder::parallel::parallel_map(image.channels.len(), |ch_idx| {
            ...
            if subsample_counter == 0 {
                ...
                if max_refs > 0 {
                    for (r, &ref_ch_idx) in ref_channel_indices.iter().enumerate() {
                        ...
                        let ref_predicted = crate::jxl_encoder::vardct::dc_coding::clamped_gradient(
                            ref_top,
                            ref_left,
                            ref_topleft,
                        );
...
pub fn estimate_bits(counts: &[u32], total: u32) -> f64 {
    ...
    for &c in counts {
        if c > 0 {
            ...
            bits -= c as f64 * crate::jxl_encoder_simd::fast_log2f(p as f32) as f64;
        }
    }
    bits
}
...
pub fn collect_residuals_with_tree(
    ...
    group_id: u32,
    wp_params: &WeightedPredictorParams,
) -> Vec<crate::jxl_encoder::entropy_coding::token::Token> {
