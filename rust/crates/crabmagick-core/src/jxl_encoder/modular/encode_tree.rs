...
use crate::jxl_encoder::entropy_coding::huffman_tree::{
...
fn write_single_leaf_tree_tokens(
    ...
    crate::jxl_encoder::trace::debug_eprintln!("  TREE_TOKENS: depths = {:?}", depths);
    crate::jxl_encoder::trace::debug_eprintln!("  TREE_TOKENS: codes = {:?}", codes);
    ...
    crate::jxl_encoder::trace::debug_eprintln!("  TREE_TOKENS [bit {}]: Done", writer.bits_written());
    Ok(())
}
