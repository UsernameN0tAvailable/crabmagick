...
use crate::jxl_decode::jxl_grid::{SharedSubgrid, SimdVector};
...
impl<'g, V> From<&'g mut crate::jxl_decode::jxl_grid::AlignedGrid<V>> for MutableSubgrid<'g, V> {
    fn from(grid: &'g mut crate::jxl_decode::jxl_grid::AlignedGrid<V>) -> Self {
