...
use crate::jxl_decode::jxl_bitstream::{Bitstream, BitstreamResult, U};
...
impl<Ctx> Bundle<Ctx> for Extensions {
    ...
    fn parse(bitstream: &mut Bitstream, _: Ctx) -> crate::jxl_decode::jxl_bitstream::BitstreamResult<Self> {
