...
use crate::jxl_decode::jxl_bitstream::{Bitstream, unpack_signed};
use crate::jxl_decode::jxl_coding::Decoder;
...
use crate::jxl_decode::jxl_modular::{Result, Sample, sample::Sealed};
...
impl Bundle<MaConfigParams<'_>> for MaConfig {
    ...
    fn parse(bitstream: &mut Bitstream, params: MaConfigParams) -> crate::jxl_decode::jxl_modular::Result<Self> {
        ...
        if is_infinite_tree_dist(&tree_decoder) {
            ...
            return Err(crate::jxl_decode::jxl_modular::Error::InvalidMaTree);
        }
        ...
        while nodes_left > 0 {
            ...
            if nodes.len() > node_limit {
                ...
                return Err(
                    crate::jxl_decode::jxl_bitstream::Error::ProfileConformance("MA tree limit exceeded").into(),
                );
            }
            ...
            match node {
                FoldingTree::Decision(property, value) => {
                    ...
                    if depth > depth_limit {
                        ...
                        return Err(crate::jxl_decode::jxl_bitstream::Error::ProfileConformance(
