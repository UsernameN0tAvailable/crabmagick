...
use crate::jxl_decode::jxl_jbr::bit_writer::BitWriter;
use crate::jxl_decode::jxl_jbr::huffman::{self, BuiltHuffmanTable};
use crate::jxl_decode::jxl_jbr::{Error, Result, ScanInfo, ScanMoreInfo};
                ...
                for ((cidx, c), (&hs, &vs)) in it {
                    ...
                    for dy8 in 0..vs {
                        ...
                        for dx8 in 0..hs {
                            ...
                            for &(x, y) in &crate::jxl_decode::jxl_vardct::DCT8_NATURAL_ORDER[ss as usize..se as usize]
                            {
