...
use crate::jxl_decode::jxl_oxide::{AuxBoxData, CropInfo, InitializeResult, JxlImage};
...
/// use crate::jxl_decode::jxl_oxide::integration::JxlDecoder;
///
...
impl<R: Read> JxlDecoder<R> {
    ...
    pub fn with_thread_pool(reader: R, pool: crate::jxl_decode::jxl_oxide::JxlThreadPool) -> ImageResult<Self> {
    ...
    fn init(builder: crate::jxl_decode::jxl_oxide::JxlImageBuilder, mut reader: R) -> ImageResult<Self> {
        ...
        if decoder.image.pixel_format().has_black() {
            decoder
                .image
                .request_color_encoding(crate::jxl_decode::jxl_color::EnumColourEncoding::srgb(
                    crate::jxl_decode::jxl_color::RenderingIntent::Relative,
                ));
        }
    ...
    fn init_image(
        builder: crate::jxl_decode::jxl_oxide::JxlImageBuilder,
        reader: &mut R,
        buf: &mut [u8],
        buf_valid: &mut usize,
    ) -> crate::jxl_decode::jxl_oxide::Result<JxlImage> {
    ...
    fn load_until_condition(
        &mut self,
        mut predicate: impl FnMut(&JxlImage) -> crate::jxl_decode::jxl_oxide::Result<bool>,
    ) -> crate::jxl_decode::jxl_oxide::Result<()> {
    ...
    fn load_until_first_keyframe(&mut self) -> crate::jxl_decode::jxl_oxide::Result<()> {
    ...
    fn load_until_exif(&mut self) -> crate::jxl_decode::jxl_oxide::Result<()> {
        self.load_until_condition(|image| Ok(!image.aux_boxes().first_exif()?.is_decoding()))
    }

    #[inline]
    fn is_float(&self) -> bool {
        use crate::jxl_decode::jxl_oxide::BitDepth;
...
fn stream_to_buf<Sample: crate::jxl_decode::jxl_oxide::FrameBufferSample>(
    mut stream: crate::jxl_decode::jxl_oxide::ImageStream<'_>,
    buf: &mut [u8],
    buf_stride: usize,
) {
    let stride =
...
/// crate::jxl_decode::jxl_oxide::integration::register_image_decoding_hook();
///
/// // Read and decode a JPEG XL image.
...
pub fn register_image_decoding_hook() -> bool {
    ...
    if registered_just_now {
        ...
        use crate::jxl_decode::jxl_bitstream::consts::{CODESTREAM_SIG, CONTAINER_SIG};
