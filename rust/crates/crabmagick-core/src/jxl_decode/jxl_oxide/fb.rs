...
use crate::jxl_decode::jxl_render::{ImageBuffer, Region};
use private::Sealed;
...
mod tests {
    ...
    fn framebuffer_grouped_len_overflow_creates_oversized_slice() {
        ...
        // UB by Miri under:
        // cargo +nightly miri test -p JXL decoder --release framebuffer_grouped_len_overflow_creates_oversized_slice
    ...
    fn framebuffer_grouped_len_overflow_exposes_mutable_oversized_slice() {
        ...
        //
        // cargo +nightly miri test -p JXL decoder --release framebuffer_grouped_len_overflow_exposes_mutable_oversized_slice
...
impl<'r> ImageStream<'r> {
    pub(crate) fn from_render(render: &'r crate::jxl_decode::jxl_oxide::Render, skip_alpha: bool) -> Self {
        use crate::jxl_decode::jxl_image::ExtraChannelType;
