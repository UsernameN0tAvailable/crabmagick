...
use crate::jxl_decode::jxl_bitstream::ParseEvent;
use crate::jxl_decode::jxl_bitstream::container::ContainerBoxType;

use crate::jxl_decode::jxl_oxide::Result;
...
impl AuxBoxList {
    pub(crate) fn jbrd(&self) -> AuxBoxData<&crate::jxl_decode::jxl_jbr::JpegBitstreamData> {
