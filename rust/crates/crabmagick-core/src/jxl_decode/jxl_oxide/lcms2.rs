...
use crate::jxl_decode::jxl_oxide::RenderingIntent;
...
impl crate::jxl_decode::jxl_oxide::ColorManagementSystem for Lcms2 {
    fn prepare_transform(
        &self,
        from_icc: &[u8],
        to_icc: &[u8],
        intent: RenderingIntent,
    ) -> Result<Box<dyn crate::jxl_decode::jxl_oxide::PreparedTransform>, Box<dyn std::error::Error + Send + Sync + 'static>>
    {
...
impl<C> crate::jxl_decode::jxl_oxide::PreparedTransform for PreparedTransform<C>
where
    C: CacheFlag,
