...
use crate::jxl_decode::jxl_render::{ImageWithRegion, Reference, Region, Result, image::ImageBuffer};
...
impl<'a> BlendParams<'a> {
    ...
    fn from_patch_blending_info(
        ...
        use crate::jxl_decode::jxl_frame::data::PatchBlendMode;
...
fn source_and_alpha_from_blending_info(
    ...
    use crate::jxl_decode::jxl_frame::header::BlendMode;
