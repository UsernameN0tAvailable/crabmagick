...
pub enum Error {
    ...
    Frame(crate::jxl_decode::jxl_frame::Error),
    Color(crate::jxl_decode::jxl_color::Error),
    IncompleteFrame,
    FailedReference,
...
impl From<crate::jxl_decode::jxl_frame::Error> for Error {
    fn from(err: crate::jxl_decode::jxl_frame::Error) -> Self {
        Self::Frame(err)
    }
}

impl From<crate::jxl_decode::jxl_color::Error> for Error {
    fn from(err: crate::jxl_decode::jxl_color::Error) -> Self {
        Self::Color(err)
    }
}
