use crate::jxl_decode::jxl_grid::AlignedGrid;
...
pub fn render_spot_color(
...
) -> crate::jxl_decode::jxl_render::Result<()> {
    let ExtraChannelType::SpotColour {
        ...
        return Err(crate::jxl_decode::jxl_render::Error::NotSupported("EC type is not SpotColour"));
    };
