...
use crate::jxl_decode::jxl_frame::{FrameHeader, data::NoiseParameters};
use crate::jxl_decode::jxl_grid::{AlignedGrid, AllocTracker, SharedSubgrid};
use crate::jxl_decode::jxl_threadpool::JxlThreadPool;

use crate::jxl_decode::jxl_render::{ImageWithRegion, Region, Result};
...
struct NoiseGroup {
    ...
    height: usize,
    stride: usize,
    _alloc_handle: Option<crate::jxl_decode::jxl_grid::AllocHandle>,
}
...
fn convolve_fill(
    mut out: crate::jxl_decode::jxl_grid::MutableSubgrid<'_, f32>,
