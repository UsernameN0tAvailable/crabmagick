...
use crate::jxl_decode::jxl_frame::data::{HfGlobal, LfGlobal, LfGroup};
...
impl<S: Sample> RenderCache<S> {
    pub fn new(frame: &crate::jxl_decode::jxl_render::IndexedFrame) -> Self {
...
pub enum FrameRender<S: Sample> {
    ...
    Err(crate::jxl_decode::jxl_render::Error),
    ErrTaken,
}
