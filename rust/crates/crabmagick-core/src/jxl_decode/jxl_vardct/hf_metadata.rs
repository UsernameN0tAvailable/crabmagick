...
use crate::jxl_decode::jxl_grid::{AlignedGrid, AllocTracker};
use crate::jxl_decode::jxl_modular::{MaConfig, Modular, ModularChannelParams, ModularParams};
use crate::jxl_decode::jxl_oxide_common::Bundle;

use crate::jxl_decode::jxl_vardct::{Result, TransformType};
            ...
            while x < bw {
                if !block_info.get(x, y).is_occupied() {
                    ...
                    if hf_mul <= 0 {
                        ...
                        return Err(
                            crate::jxl_decode::jxl_bitstream::Error::ValidationFailed("non-positive HfMul").into()
                        );
                    }
