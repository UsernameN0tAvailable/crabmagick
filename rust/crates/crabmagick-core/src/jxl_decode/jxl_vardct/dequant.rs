...
use crate::jxl_decode::jxl_modular::{Modular, ModularParams};
...
pub struct DequantMatrixSetParams<'a, 'pool, 'tracker> {
    ...
    bit_depth: u32,
    stream_index: u32,
    global_ma_config: Option<&'a crate::jxl_decode::jxl_modular::MaConfig>,
    tracker: Option<&'tracker AllocTracker>,
    pool: &'pool crate::jxl_decode::jxl_threadpool::JxlThreadPool,
}
        ...
        let encoding = match encoding_mode {
            ...
            7 => {
                ...
                let modular_params = ModularParams::new(
                    ...
                    256,
                    bit_depth,
                    vec![crate::jxl_decode::jxl_modular::ChannelShift::from_shift(0); 3],
                    global_ma_config,
                    tracker,
                );
