use crate::jxl_decode::jxl_color::RenderingIntent;
...
///
/// Prepared transformations may be cached by JXL decoder internally.
...
impl ColorManagementSystem for NullCms {
    ...
    {
        Err(Box::new(crate::jxl_decode::jxl_color::Error::CmsNotAvailable))
    }
}
