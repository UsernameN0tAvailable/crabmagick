...
//!
//! # Usage
//! Add JPEG decoder to the dependencies in the project Cargo.toml
//!
//! ```toml
//! [dependencies]
//! crabmagick-core = "0.1.2"
//! ```
//! # Examples
//!
...
//! ```
//!
//! 3. Anything that implements [ZByteReaderTrait](jpeg_decode_core::bytestream::traits::ZByteReaderTrait)
//!
...
//!
//![`DecoderOptions::set_use_unsafe(false)`]:  https://docs.rs/crabmagick-core/latest/crabmagick_core/jpeg_decode_core/options/struct.DecoderOptions.html#method.set_use_unsafe

#![allow(warnings, clippy::all, unused)]

pub use crate::jpeg_decode::components::SampleRatios;
pub use crate::jpeg_decode::decoder::{ImageInfo, JpegDecoder};
pub use crate::jpeg_decode::marker::Marker;
mod bitstream;
mod color_convert;
mod components;
mod decoder;
