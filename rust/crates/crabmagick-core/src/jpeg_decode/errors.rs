...
use crate::jpeg_decode_core::bytestream::ZByteIoError;

use crate::jpeg_decode::misc::{
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> core::fmt::Result {
        match &self
        {
            ...
            Self::LargeDimensions(dimensions) => write!(
                f,
                "Too large dimensions {dimensions},library supports up to {}", crate::jpeg_decode::decoder::MAX_DIMENSIONS
            ),
