...
pub use crate::jpeg_decode::color_convert::avx::{ycbcr_to_rgb_avx2, ycbcr_to_rgba_avx2};
use crate::jpeg_decode::decoder::ColorConvert16Ptr;
...
pub fn choose_ycbcr_to_rgb_convert_func(
    ...
    #[cfg(target_arch = "x86_64")]
    {
        use crate::jpeg_decode_core::log::debug;
        if options.use_avx2() {
            #[cfg(feature = "std")]
            if std::is_x86_feature_detected!("avx512f") && std::is_x86_feature_detected!("avx512bw")
            {
                debug!("Using AVX-512 optimised color conversion functions");
                match type_need {
                    ColorSpace::RGB => return Some(avx512::ycbcr_to_rgb_avx512),
                    ColorSpace::RGBA => return Some(avx512::ycbcr_to_rgba_avx512),
    ...
    {
        if options.use_neon() {
            use crate::jpeg_decode::color_convert::neon64::{ycbcr_to_rgb_neon, ycbcr_to_rgba_neon};
            match type_need {
