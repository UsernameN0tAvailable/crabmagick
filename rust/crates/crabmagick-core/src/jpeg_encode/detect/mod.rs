...
//!
//! ```rust,ignore
//! use JPEG encoder::detect::{probe, EncoderFamily, QualityScale};
//!
...
use crate::jpeg_encode::foundation::consts::{MARKER_SOF0, MARKER_SOF2};
...
mod tests {
    ...
    fn build_minimal_jpeg(quality: u8, progressive: bool) -> Vec<u8> {
        ...
        use crate::jpeg_encode::foundation::consts::MARKER_DHT;
