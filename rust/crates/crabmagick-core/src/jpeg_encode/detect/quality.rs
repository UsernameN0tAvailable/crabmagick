...
use crate::jpeg_encode::encode::tables::robidoux::{ROBIDOUX_LUMINANCE, quality_to_scale_factor, scale_table};
...
fn estimate_jpegli_quality(scan: &ScanResult) -> QualityEstimate {
    ...
    let distance = crate::jpeg_encode::quant::quant_vals_to_distance(&y_qt, &cb_qt, &cr_qt);
...
fn natural_to_quant_table(natural: &[u16; 64], precision: u8) -> crate::jpeg_encode::types::QuantTable {
    ...
    crate::jpeg_encode::types::QuantTable {
        values: zigzag,
        precision,
    }
}
