...
use crate::jpeg_encode::color::{ycbcr_planes_i16_to_rgb_u8, ycbcr_to_rgb, ycbcr_to_rgb_f32};
use crate::jpeg_encode::deblock::BoundaryStrength;
use crate::jpeg_encode::entropy::{EntropyDecoder, EntropyDecoderState};
use crate::jpeg_encode::error::{Error, Result, ScanRead};
use crate::jpeg_encode::foundation::consts::{DCT_BLOCK_SIZE, MAX_HUFFMAN_TABLES};
use crate::jpeg_encode::huffman::HuffmanDecodeTable;
use crate::jpeg_encode::types::{ColorSpace, Dimensions, Subsampling};
            ...
            for mcu_x in 0..mcu_cols {
                for h in 0..h_blocks {
                    ...
                    if coeff_count <= 1 {
                        ...
                        crate::jpeg_encode::quant::dequantize_unzigzag_i32_into_partial(
                            &temp_coeffs,
                            quant,
                            &mut dequant_buf,
                            coeff_count,
...
mod tests {
    ...
    fn encode_rgb(width: u32, height: u32, pixels: &[u8], quality: f32) -> Vec<u8> {
        use crate::jpeg_encode::encode::v2::{ChromaSubsampling, EncoderConfig, PixelLayout};
    ...
    fn encode_rgb_subsampled(
        ...
        pixels: &[u8],
        quality: f32,
        subsampling: crate::jpeg_encode::encode::v2::ChromaSubsampling,
    ) -> Vec<u8> {
        use crate::jpeg_encode::encode::v2::{EncoderConfig, PixelLayout};
        use enough::Unstoppable;
    ...
    fn test_scanline_reader_rgb8() {
        use crate::jpeg_encode::decode::Decoder;
    ...
    fn test_scanline_reader_420() {
        use crate::jpeg_encode::decode::Decoder;
        use crate::jpeg_encode::encode::v2::ChromaSubsampling;
    ...
    fn test_scanline_reader_progressive() {
        ...
        // Decode via scanline reader
        let decoder = crate::jpeg_encode::decode::Decoder::new();
        let mut reader = decoder
    ...
    fn test_crop_pixel_scanline_444() {
        use crate::jpeg_encode::decode::DecodeConfig;
        use crate::jpeg_encode::decode::config::CropRegion;
    ...
    fn test_crop_pixel_scanline_420() {
        ...
        let jpeg = encode_rgb_subsampled(
            ...
            &pixels,
            95.0,
            crate::jpeg_encode::encode::v2::ChromaSubsampling::Quarter,
        );
