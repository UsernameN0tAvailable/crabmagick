...
pub use crate::jpeg_encode::encode::extras::{
...
pub use crate::jpeg_encode::detect::{
...
impl DecodedExtras {
    ...
    /// ```
    #[must_use]
    pub fn to_encoder_segments(&self) -> crate::jpeg_encode::encode::extras::EncoderSegments {
    ...
    pub fn to_encoder_segments_filtered<F>(
        &self,
        filter: F,
    ) -> crate::jpeg_encode::encode::extras::EncoderSegments
    where
