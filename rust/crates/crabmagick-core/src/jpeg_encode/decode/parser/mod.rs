...
use crate::jpeg_encode::color::icc::{extract_icc_profile, is_xyb_profile};
use crate::jpeg_encode::error::{Error, ErrorKind, Result};
use crate::jpeg_encode::foundation::alloc::{MAX_SCANS, checked_size_2d};
...
use crate::jpeg_encode::types::{ColorSpace, Component, Dimensions, JpegMode};
use enough::Stop;
...
impl<'a> JpegParser<'a> {
    ...
    pub(super) fn extract_coefficients(&self) -> Result<crate::jpeg_encode::decode::image::DecodedCoefficients> {
        use crate::jpeg_encode::decode::image::{ComponentCoefficients, DecodedCoefficients};
