...
use crate::jpeg_encode::lossless::{BlockTransform, LosslessTransform, remap_block};
...
impl<'a> JpegParser<'a> {
    ...
    pub(in crate::jpeg_encode::decode) fn apply_dct_transform(&mut self, transform: LosslessTransform) {
