...
//!
//! See `crate::jpeg_encode::huffman::build_code_lengths()` for the jpegli-style implementation.
...
mod tests {
    ...
    fn load_cpp_testdata() -> Option<Vec<(Vec<i64>, Vec<u8>)>> {
        let path = crate::jpeg_encode::test_utils::get_cpp_testdata_path("CreateHuffmanTree.testdata")?;
