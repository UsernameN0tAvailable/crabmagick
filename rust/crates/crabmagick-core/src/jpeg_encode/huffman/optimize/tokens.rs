...
impl Token {
    ...
    pub fn dc(context: u8, diff: i16) -> Self {
        let category = crate::jpeg_encode::entropy::category(diff);
        let extra = crate::jpeg_encode::entropy::additional_bits_with_cat(diff, category);
    ...
    pub fn ac(context: u8, run: u8, value: i16) -> Self {
        if value == 0 {
            ...
            let category = crate::jpeg_encode::entropy::category(value);
            let extra = crate::jpeg_encode::entropy::additional_bits_with_cat(value, category);
