...
//! - Decoder-specific errors in [`crate::jpeg_encode::decoder::error`]
//! - Encoder-specific errors in [`crate::jpeg_encode::encoder::error`]
...
pub enum ArgumentError {
    ...
    UnsupportedPixelFormat { format: crate::jpeg_encode::types::PixelFormat },
}
...
impl From<crate::jpeg_encode::foundation::aligned_alloc::AllocError> for Error {
    #[track_caller]
    fn from(err: crate::jpeg_encode::foundation::aligned_alloc::AllocError) -> Self {
        match err {
            crate::jpeg_encode::foundation::aligned_alloc::AllocError::OutOfMemory => {
                Self::allocation_failed(0, "adaptive quantization")
            }
            crate::jpeg_encode::foundation::aligned_alloc::AllocError::Overflow => {
