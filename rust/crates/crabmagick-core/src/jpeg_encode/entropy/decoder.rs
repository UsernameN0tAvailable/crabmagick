...
use crate::jpeg_encode::foundation::bitstream::BitReader;
...
pub struct EntropyDecoderState {
    reader_state: crate::jpeg_encode::foundation::bitstream::BitReaderState,
    prev_dc: [i16; 4],
    last_written: u8,
}
...
impl<'data, 'tables> EntropyDecoder<'data, 'tables> {
    ...
    pub fn decode_block_with_count(
        ...
        // This is the JPEG decoder optimization - consecutive blocks have similar sparsity.
