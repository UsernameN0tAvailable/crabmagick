...
use crate::jpeg_encode::decode::DecodedExtras;
use crate::jpeg_encode::decoder::Decoder;
...
///
/// ```rust,ignore
/// use JPEG encoder::ultrahdr::create_hdr_reconstructor;
///
...
/// use JPEG encoder::ultrahdr::{tonemapper_from_ultrahdr, encode_ultrahdr_with_tonemapper};
///
...
mod tests {
    use super::*;
    use crate::jpeg_encode::decode::SegmentType;
