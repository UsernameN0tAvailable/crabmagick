...
use crate::jpeg_encode::foundation::consts::JPEG_NATURAL_ORDER;
...
use crate::jpeg_encode::decode::{ComponentCoefficients, DecodedCoefficients};
...
mod pipeline_tests {
    ...
    use crate::jpeg_encode::lossless::{EdgeHandling, LosslessTransform, TransformConfig, transform};
    use enough::Unstoppable;

    /// Create a test JPEG from a known pixel pattern using JPEG encoder encoder.
    fn create_test_jpeg(width: u32, height: u32) -> Vec<u8> {
        use crate::jpeg_encode::encoder::{ChromaSubsampling, EncoderConfig, PixelLayout};
...
mod exif_tests {
    use crate::jpeg_encode::lossless::coeff_transform::LosslessTransform;
    use crate::jpeg_encode::lossless::exif::{parse_exif_orientation, set_exif_orientation};
    ...
    fn test_apply_exif_orientation_no_exif() {
        ...
        use crate::jpeg_encode::encoder::{ChromaSubsampling, EncoderConfig, PixelLayout};
        use crate::jpeg_encode::lossless::apply_exif_orientation;
        use enough::Unstoppable;
    ...
    fn test_apply_exif_orientation_normal() {
        ...
        use crate::jpeg_encode::encoder::{ChromaSubsampling, EncoderConfig, Exif, Orientation, PixelLayout};
        use crate::jpeg_encode::lossless::apply_exif_orientation;
        use enough::Unstoppable;
    ...
    fn test_apply_exif_orientation_rotate90() {
        ...
        use crate::jpeg_encode::decode::{DecodeConfig, PreserveConfig};
        use crate::jpeg_encode::encoder::{ChromaSubsampling, EncoderConfig, Exif, Orientation, PixelLayout};
        use crate::jpeg_encode::lossless::apply_exif_orientation;
        use enough::Unstoppable;
...
fn encode_test_image(
    ...
    h: u32,
    pixels: &[u8],
    orientation: Option<crate::jpeg_encode::encoder::Orientation>,
) -> Vec<u8> {
    use crate::jpeg_encode::encoder::{ChromaSubsampling, EncoderConfig, Exif, PixelLayout};
    use enough::Unstoppable;
...
fn decode_test(jpeg: &[u8], config: &crate::jpeg_encode::decode::DecodeConfig) -> (u32, u32, Vec<u8>) {
    use enough::Unstoppable;
...
fn scanline_decode_test(jpeg: &[u8], config: &crate::jpeg_encode::decode::DecodeConfig) -> (u32, u32, Vec<u8>) {
    use imgref::ImgRefMut;
...
fn test_auto_orient_all_orientations() {
    use crate::jpeg_encode::decode::DecodeConfig;
    use crate::jpeg_encode::encoder::Orientation;
...
mod restructure_tests {
    use crate::jpeg_encode::decode::DecodeConfig;
    use crate::jpeg_encode::lossless::{
    ...
    fn test_restructure_preserves_metadata() {
        ...
        let decoder = DecodeConfig::new().preserve(crate::jpeg_encode::decode::PreserveConfig::all());
