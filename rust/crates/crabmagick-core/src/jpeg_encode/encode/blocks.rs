...
use crate::jpeg_encode::entropy::{self, EntropyEncoder};
...
use crate::jpeg_encode::huffman::optimize::{FrequencyCounter, HuffmanTableSet};
...
impl HuffmanSymbolFrequencies {
    ...
    pub fn generate_tables(&self) -> Result<HuffmanTableSet> {
        self.generate_tables_with_method(crate::jpeg_encode::types::HuffmanMethod::JpegliCreateTree)
    }
...
impl ComputedConfig {
    ...
    pub(crate) fn build_optimized_tables_xyb_raster(
        ...
        crate::jpeg_encode::huffman::optimize::OptimizedTable,
        crate::jpeg_encode::huffman::optimize::OptimizedTable,
    )> {
        ...
        let huffman_method = crate::jpeg_encode::types::HuffmanMethod::JpegliCreateTree;
    ...
    pub(crate) fn encode_with_tables_xyb_raster(
        ...
        y_blocks: &[[i16; DCT_BLOCK_SIZE]],
        b_blocks: &[[i16; DCT_BLOCK_SIZE]],
        dc_table: &crate::jpeg_encode::huffman::optimize::OptimizedTable,
        ac_table: &crate::jpeg_encode::huffman::optimize::OptimizedTable,
    ) -> Result<Vec<u8>> {
        let width = self.width as usize;
        let height = self.height as usize;
