...
use crate::jpeg_encode::huffman::optimize::FrequencyCounter;
use crate::jpeg_encode::huffman::optimize::cluster::cluster_histograms;
...
mod tests {
    use super::*;
    use crate::jpeg_encode::encode::scan_optimize::ScanSearchConfig;
    use crate::jpeg_encode::encode::scan_optimize::generate::generate_search_scans;
