...
impl EncodingTables {
    ...
    pub fn xyb_hq_zero_bias_mul() -> PerComponent<[f32; 64]> {
        use crate::jpeg_encode::quant::ZERO_BIAS_MUL_XYB_HQ;
        PerComponent {
    ...
    pub fn generate_quant_table(
        ...
        distance: f32,
        is_420: bool,
    ) -> crate::jpeg_encode::quant::QuantTable {
        use crate::jpeg_encode::quant::create_quant_table;
    ...
    fn compute_scaled_quant(
        ...
        use crate::jpeg_encode::foundation::consts::{GLOBAL_SCALE_420, K420_RESCALE};
        use crate::jpeg_encode::quant::{DIST_THRESHOLD, create_quant_table};
    ...
    /// * `component` - 0 for Y/X, 1 for Cb/Y, 2 for Cr/B
    #[must_use]
    pub fn generate_zero_bias_params(&self, component: usize) -> crate::jpeg_encode::quant::ZeroBiasParams {
        let c = component.min(2);
        ...
        crate::jpeg_encode::quant::ZeroBiasParams { mul, offset }
    }
    ...
    pub fn generate_zero_bias_all(
        ...
        crate::jpeg_encode::quant::ZeroBiasParams,
        crate::jpeg_encode::quant::ZeroBiasParams,
        crate::jpeg_encode::quant::ZeroBiasParams,
    ) {
        (
...
mod tests {
    ...
    fn test_optimized_scaling_params() {
        use crate::jpeg_encode::quant::{OPTIMIZED_FREQUENCY_EXPONENT, OPTIMIZED_GLOBAL_SCALE};
