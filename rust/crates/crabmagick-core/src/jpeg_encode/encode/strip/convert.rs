...
impl StripProcessor {
    ...
    pub(super) fn copy_ycbcr_to_strips(
        ...
        if y_row.len() < expected_y_size {
            return Err(crate::jpeg_encode::error::Error::internal("Y plane too small for strip"));
        }

        if !self.pixel_format.is_grayscale()
            && (cb_row.len() < expected_y_size || cr_row.len() < expected_y_size)
        {
            return Err(crate::jpeg_encode::error::Error::internal(
    ...
    pub(super) fn convert_strip_to_ycbcr(
        ...
        match self.pixel_format {
            PixelFormat::Rgb | PixelFormat::Rgba => {
                ...
                #[cfg(feature = "yuv")]
                {
                    crate::jpeg_encode::encode_simd::rgb_to_ycbcr_strided_reuse(
                        rgb_strip,
                ...
                #[cfg(not(feature = "yuv"))]
                {
                    crate::jpeg_encode::encode_simd::rgb_to_ycbcr_strided_inplace(
                        rgb_strip,
                        &mut self.y_strip[..y_size],
                        &mut self.cb_strip[..num_pixels],
                        &mut self.cr_strip[..num_pixels],
            ...
            PixelFormat::Bgr => {
                ...
                #[cfg(feature = "yuv")]
                {
                    crate::jpeg_encode::encode_simd::bgr_to_ycbcr_strided_reuse(
                        rgb_strip,
                        &mut self.y_strip[..y_size],
                        &mut self.cb_strip[..num_pixels],
                        &mut self.cr_strip[..num_pixels],
                ...
                #[cfg(not(feature = "yuv"))]
                {
                    crate::jpeg_encode::encode_simd::bgr_to_ycbcr_strided_inplace(
                        rgb_strip,
                        &mut self.y_strip[..y_size],
                        &mut self.cb_strip[..num_pixels],
                        &mut self.cr_strip[..num_pixels],
    ...
    pub(super) fn convert_strip_to_ycbcr_420(
        ...
        match self.pixel_format {
            PixelFormat::Rgb | PixelFormat::Rgba => {
                let bpp = self.pixel_format.bytes_per_pixel();
                crate::jpeg_encode::color::fast_yuv::rgb_to_ycbcr_420_reuse(
                    rgb_strip,
                    &mut self.y_strip[..y_size],
            ...
            PixelFormat::Bgr | PixelFormat::Bgra | PixelFormat::Bgrx => {
                let bpp = self.pixel_format.bytes_per_pixel();
                crate::jpeg_encode::color::fast_yuv::bgr_to_ycbcr_420_reuse(
                    rgb_strip,
                    &mut self.y_strip[..y_size],
                    &mut self.cb_down[..c_size],
                    &mut self.cr_down[..c_size],
    ...
    pub(super) fn convert_strip_to_xyb(
        ...
        use crate::jpeg_encode::color::xyb::srgb_to_scaled_xyb;
        ...
        for row in 0..strip_height {
            ...
            for x in 0..width {
                ...
                let (scaled_x, scaled_y, scaled_b) = crate::jpeg_encode::color::xyb::linear_rgb_to_xyb_255(
                    r_linear * 255.0,
                    g_linear * 255.0,
                    b_linear * 255.0,
                );
        ...
        crate::jpeg_encode::encode_simd::downsample_2x2_simd_inplace(
    ...
    pub(super) fn convert_strip_gamma_aware(
        ...
        match self.layout.subsampling {
            Subsampling::S420 => {
                crate::jpeg_encode::encode::chroma::gamma_aware_strip_420(
                    rgb_strip,
            ...
            Subsampling::S422 => {
                crate::jpeg_encode::encode::chroma::gamma_aware_strip_422(
                    rgb_strip,
                    &mut self.y_strip[..num_pixels],
                    &mut self.cb_down[..c_size],
                    &mut self.cr_down[..c_size],
            ...
            Subsampling::S440 => {
                crate::jpeg_encode::encode::chroma::gamma_aware_strip_440(
                    rgb_strip,
                    &mut self.y_strip[..num_pixels],
                    &mut self.cb_down[..c_size],
                    &mut self.cr_down[..c_size],
    ...
    pub(super) fn convert_strip_box_fused(
        ...
        match self.layout.subsampling {
            Subsampling::S420 => {
                crate::jpeg_encode::encode::chroma::box_fused_strip_420(
                    rgb_strip,
                    &mut self.y_strip[..num_pixels],
                    &mut self.cb_down[..c_size],
                    &mut self.cr_down[..c_size],
            ...
            Subsampling::S422 => {
                crate::jpeg_encode::encode::chroma::box_fused_strip_422(
                    rgb_strip,
                    &mut self.y_strip[..num_pixels],
                    &mut self.cb_down[..c_size],
                    &mut self.cr_down[..c_size],
            ...
            Subsampling::S440 => {
                crate::jpeg_encode::encode::chroma::box_fused_strip_440(
                    rgb_strip,
                    &mut self.y_strip[..num_pixels],
                    &mut self.cb_down[..c_size],
                    &mut self.cr_down[..c_size],
    ...
    pub(super) fn downsample_chroma_strip(&mut self, strip_height: usize) -> Result<()> {
        ...
        match self.layout.subsampling {
            ...
            Subsampling::S422 => {
                crate::jpeg_encode::encode_simd::downsample_2x1_simd_inplace(
                    &self.cb_strip[..num_pixels],
                    width,
                    strip_height,
                    &mut self.cb_down[..c_size],
            ...
            Subsampling::S440 => {
                crate::jpeg_encode::encode_simd::downsample_1x2_simd_inplace(
                    &self.cb_strip[..num_pixels],
                    width,
                    strip_height,
                    &mut self.cb_down[..c_size],
