...
use crate::jpeg_encode::encode::encoder_types::DownsamplingMethod;
use crate::jpeg_encode::encode::layout::LayoutParams;
use crate::jpeg_encode::error::Result;
use crate::jpeg_encode::foundation::alloc::{
...
use crate::jpeg_encode::foundation::simd_types::{QuantTableSimd, ZeroBiasSimd};
use crate::jpeg_encode::quant::aq::streaming::StreamingAQ;
use crate::jpeg_encode::quant::{QuantTable, ZeroBiasParams};
use crate::jpeg_encode::types::{PixelFormat, Subsampling};

// Trellis quantization support
#[cfg(feature = "trellis")]
use crate::jpeg_encode::encode::trellis::HybridQuantContext;
#[cfg(feature = "trellis")]
use crate::jpeg_encode::encode::trellis::TrellisConfig;
#[cfg(feature = "trellis")]
...
fn forward_dct_dispatch(
    token: Option<crate::jpeg_encode::encode::mage_simd::Desktop64>,
    block: &Block8x8f,
) -> Block8x8f {
    if let Some(t) = token {
        return crate::jpeg_encode::encode::mage_simd::mage_forward_dct_8x8_wide(t, block);
    }
    crate::jpeg_encode::encode::dct::simd::forward_dct_8x8_wide(block)
}
...
pub struct StripProcessor {
    ...
    stats: crate::jpeg_encode::foundation::alloc::EncodeStats,
    ...
    #[cfg(target_arch = "x86_64")]
    simd_token: Option<crate::jpeg_encode::encode::mage_simd::Desktop64>,
...
impl StripProcessor {
    ...
    fn with_xyb_inner(
        ...
        Ok(Self {
            ...
            simd_token: {
                ...
                crate::jpeg_encode::encode::mage_simd::Desktop64::summon()
            },
    ...
    #[inline]
    #[must_use]
    pub fn simd_token(&self) -> Option<crate::jpeg_encode::encode::mage_simd::Desktop64> {
        self.simd_token
    }
    ...
    #[cfg(feature = "trellis")]
    pub fn set_hybrid(&mut self, config: crate::jpeg_encode::encode::trellis::HybridConfig) {
    ...
    pub fn process_strip_ycbcr_f32(
        ...
        if self.layout.use_xyb {
            return Err(crate::jpeg_encode::error::Error::unsupported_feature(
...
fn dc_trellis_channel_row_by_row(
    ...
    blocks_w: usize,
    dc_quantval: u16,
    dc_table: &crate::jpeg_encode::encode::trellis::RateTable,
    lambda1: f32,
    lambda2: f32,
    delta_dc_weight: f32,
) {
    ...
    for row in 0..blocks_h {
        ...
        last_dc = crate::jpeg_encode::encode::trellis::dc_trellis_optimize_indexed(
            &raw_blocks,
            &mut natural_blocks,
            &indices,
            dc_quantval,
...
mod tests {
    ...
    fn test_strip_partial_mcu_heights() {
        ...
        for height in 56..=72 {
            ...
            let config = EncoderConfig::ycbcr(85.0, crate::jpeg_encode::encode::ChromaSubsampling::Quarter)
                .progressive(false)
            ...
            // Decode and verify
            let decoded_strip = crate::jpeg_encode::decode::Decoder::new()
