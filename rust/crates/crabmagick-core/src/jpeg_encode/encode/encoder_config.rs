...
use crate::jpeg_encode::types::EdgePaddingConfig;
...
impl EncoderConfig {
    ...
    /// # Example
    /// ```ignore
    /// use JPEG encoder::encoder::{EncoderConfig, XybSubsampling};
    ///
    ...
    /// # Example
    /// ```ignore
    /// use JPEG encoder::encoder::EncoderConfig;
    ///
    ...
    ///
    /// ```rust,ignore
    /// use JPEG encoder::encoder::{EncoderConfig, ProgressiveScanMode, ChromaSubsampling};
    ///
    /// // Boolean
    ...
    ///
    /// ```rust,ignore
    /// use JPEG encoder::encode::{EncoderConfig, ChromaSubsampling, QuantTableConfig};
    ///
    /// let config = EncoderConfig::ycbcr(85, ChromaSubsampling::Quarter)
    ...
    pub fn optimization(self, preset: super::encoder_types::OptimizationPreset) -> Self {
        ...
        // - Hybrid: Adaptive (JPEG encoder heuristic, good speed/quality balance)
        #[cfg(feature = "trellis")]
        let trellis = {
    ...
    ///
    /// ```rust,ignore
    /// use JPEG encoder::encoder::{EncoderConfig, HuffmanStrategy, HuffmanTableSet};
    ///
    ...
    ///
    /// ```ignore
    /// use JPEG encoder::{EncoderConfig, ChromaSubsampling, ParallelEncoding};
    ///
    ...
    ///
    /// ```rust,ignore
    /// use JPEG encoder::encode::{EncoderConfig, ExpertConfig, QuantTableConfig, ChromaSubsampling};
    /// use JPEG encoder::encode::trellis::TrellisConfig;
    ///
    /// let config = EncoderConfig::ycbcr(85, ChromaSubsampling::Quarter)
    ...
    /// # Example
    /// ```
    /// use JPEG encoder::encode::{EncoderConfig, ChromaSubsampling};
    /// use JPEG encoder::encode::tuning::EncodingTables;
    ///
    ...
    #[doc(hidden)]
    #[must_use]
    pub fn custom_huffman_tables(self, tables: crate::jpeg_encode::huffman::optimize::HuffmanTableSet) -> Self {
        self.huffman(tables)
    }
    ...
    pub fn validate(&self) -> Result<()> {
        if self.scan_mode.is_progressive() && !matches!(self.huffman, HuffmanStrategy::Optimize) {
            return Err(crate::jpeg_encode::error::Error::invalid_config(
    ...
    /// # Example
    /// ```ignore
    /// use JPEG encoder::{EncoderConfig, ChromaSubsampling, PixelLayout, Unstoppable};
    /// let config = EncoderConfig::ycbcr(85.0, ChromaSubsampling::Quarter);
    ...
    /// ```ignore
    /// use rgb::RGB;
    /// use JPEG encoder::{EncoderConfig, ChromaSubsampling, Unstoppable};
    ///
    /// let config = EncoderConfig::ycbcr(85.0, ChromaSubsampling::Quarter);
    ...
    pub fn estimate_memory(&self, width: u32, height: u32) -> usize {
        use crate::jpeg_encode::encode::streaming::StreamingEncoder;

        let subsampling = match self.color_mode {
            ColorMode::YCbCr { subsampling } => subsampling.into(),
            ColorMode::Xyb { .. } => crate::jpeg_encode::types::Subsampling::S444,
            ColorMode::Grayscale => crate::jpeg_encode::types::Subsampling::S444,
        };
    ...
    ///
    /// ```rust,ignore
    /// use JPEG encoder::encoder::{EncoderConfig, ChromaSubsampling, MpfImageType};
    ///
    /// let config = EncoderConfig::ycbcr(90.0, ChromaSubsampling::Quarter)
...
mod tests {
    use super::*;
    #[cfg(feature = "trellis")]
    use crate::jpeg_encode::encode::trellis::TrellisSpeedMode;
    ...
    fn test_optimization_preset_jpegli_baseline() {
        use crate::jpeg_encode::encode::encoder_types::{
    ...
    fn test_optimization_preset_overridable() {
        use crate::jpeg_encode::encode::encoder_types::{OptimizationPreset, ProgressiveScanMode};
    ...
    fn test_progressive_accepts_bool_and_enum() {
        use crate::jpeg_encode::encode::encoder_types::ProgressiveScanMode;
    ...
    fn test_quant_table_config_custom() {
        use crate::jpeg_encode::encode::encoder_types::QuantTableConfig;
        let tables = crate::jpeg_encode::encode::tuning::EncodingTables::default_ycbcr();
    ...
    fn test_effort_constructors_fast() {
        use crate::jpeg_encode::encode::encoder_types::Effort;
