...
impl BytesEncoder {
    ...
    fn build_streaming_encoder(
        ...
        use crate::jpeg_encode::encode::streaming::StreamingEncoder as SE;
        ...
        let subsampling = match config.color_mode {
            ...
            super::encoder_types::ColorMode::Xyb { .. } => crate::jpeg_encode::types::Subsampling::S444,
            super::encoder_types::ColorMode::Grayscale => crate::jpeg_encode::types::Subsampling::S444,
        };
    ...
    pub fn push_packed(&mut self, data: &[u8], stop: impl Stop) -> Result<()> {
        ...
        if self.config.pre_blur > 0.0 {
            ...
            if self.layout == PixelLayout::Rgb8Srgb {
                let blurred = crate::jpeg_encode::blur::gaussian_blur_rgb(data, w, h, self.config.pre_blur);
    ...
    #[must_use]
    pub fn encode_stats(&self) -> &crate::jpeg_encode::foundation::alloc::EncodeStats {
...
impl YCbCrPlanarEncoder {
    ...
    fn build_streaming_encoder(
        ...
        let subsampling = match config.color_mode {
            super::encoder_types::ColorMode::YCbCr { subsampling } => subsampling.into(),
            _ => crate::jpeg_encode::types::Subsampling::S444,
        };
...
mod tests {
    use super::*;
    use crate::jpeg_encode::encode::ChromaSubsampling;
    ...
    fn test_icc_roundtrip_extraction() {
        ...
        let extracted = crate::jpeg_encode::color::icc::extract_icc_profile(&jpeg);
    ...
    fn test_ycbcr_planar_encoder_basic() {
        use crate::jpeg_encode::encode::YCbCrPlanes;
    ...
    fn test_ycbcr_planar_encoder_requires_ycbcr_mode() {
        ...
        let config = EncoderConfig::xyb(85, crate::jpeg_encode::encode::encoder_types::XybSubsampling::BQuarter);
