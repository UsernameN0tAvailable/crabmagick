...
//!
//! ```ignore
//! use JPEG encoder::encode::tuning::{EncodingTables, PerComponent};
//! use JPEG encoder::encode::tables;
//!
...
//! use JPEG encoder::encode::{MozjpegTables, QuantTablePreset};
...
pub use crate::jpeg_encode::foundation::consts::{
...
pub use crate::jpeg_encode::foundation::consts::{GLOBAL_SCALE_420, GLOBAL_SCALE_XYB, GLOBAL_SCALE_YCBCR};

// Re-export zero-bias tables
pub use crate::jpeg_encode::quant::{
