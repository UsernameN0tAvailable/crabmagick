...
/// - **Hybrid** — combines jpegli AQ + mozjpeg trellis (JPEG encoder-only)
///
/// # Preset Matrix
///
...
pub enum OptimizationPreset {
    ...
    // === Hybrid lineage (JPEG encoder-unique) ===
...
pub enum HuffmanStrategy {
    ...
    Custom(Box<crate::jpeg_encode::huffman::optimize::HuffmanTableSet>),
}
...
impl From<crate::jpeg_encode::huffman::optimize::HuffmanTableSet> for HuffmanStrategy {
    fn from(tables: crate::jpeg_encode::huffman::optimize::HuffmanTableSet) -> Self {
...
impl From<crate::jpeg_encode::types::PixelFormat> for PixelLayout {
    fn from(format: crate::jpeg_encode::types::PixelFormat) -> Self {
        use crate::jpeg_encode::types::PixelFormat;
        match format {
