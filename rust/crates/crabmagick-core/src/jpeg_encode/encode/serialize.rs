...
use crate::jpeg_encode::huffman::optimize::{ContextConfig, HuffmanTableSet, OptimizedTable};
use crate::jpeg_encode::quant::QuantTable;
use crate::jpeg_encode::types::{JpegMode, Subsampling};
...
impl ComputedConfig {
    ...
    pub(crate) fn write_huffman_tables_optimized(
        ...
        // This matches C++ jpegli and is expected by JPEG decoder
