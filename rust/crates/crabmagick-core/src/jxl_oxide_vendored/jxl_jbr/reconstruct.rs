...
use crate::jxl_oxide_vendored::jxl_frame::header::Encoding;
use crate::jxl_oxide_vendored::jxl_frame::{Frame, FrameHeader};
use crate::jxl_oxide_vendored::jxl_grid::{AlignedGrid, SharedSubgrid};
use crate::jxl_oxide_vendored::jxl_modular::ChannelShift;

use super::*;
use crate::jxl_oxide_vendored::jxl_jbr::huffman::BuiltHuffmanTable;
    ...
    fn process_next(&mut self, mut writer: impl Write) -> Result<()> {
        ...
        match marker {
            ...
            0xda => {
                ...
                jpeg_upsampling_ycbcr.swap(0, 1);
                let upsampling_shifts_ycbcr: [_; 3] = std::array::from_fn(|idx| {
                    crate::jxl_oxide_vendored::jxl_modular::ChannelShift::from_jpeg_upsampling(jpeg_upsampling_ycbcr, idx)
                });
            ...
            0xdb => {
                ...
                for qt in qts {
                    ...
                    if let Some(q) = q {
                        ...
                        // Transposed for DCT8
                        for (&(y, x), q_val) in
                            std::iter::zip(crate::jxl_oxide_vendored::jxl_vardct::DCT8_NATURAL_ORDER, q_val)
                        {
