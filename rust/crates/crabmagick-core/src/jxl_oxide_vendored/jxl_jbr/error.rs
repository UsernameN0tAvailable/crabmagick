...
pub enum Error {
    ...
    FrameDataIncomplete,
    FrameParse(crate::jxl_oxide_vendored::jxl_frame::Error),
    IncompatibleFrame,
}

impl From<crate::jxl_oxide_vendored::jxl_bitstream::Error> for Error {
    fn from(value: crate::jxl_oxide_vendored::jxl_bitstream::Error) -> Self {
        Self::Bitstream(value)
    }
}

impl From<crate::jxl_oxide_vendored::jxl_frame::Error> for Error {
    fn from(value: crate::jxl_oxide_vendored::jxl_frame::Error) -> Self {
