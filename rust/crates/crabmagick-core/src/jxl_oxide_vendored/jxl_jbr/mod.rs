...
use crate::jxl_oxide_vendored::jxl_frame::Frame;
use crate::jxl_oxide_vendored::jxl_oxide_common::Bundle;

use crate::jxl_oxide_vendored::jxl_jbr::huffman::HuffmanCode;
...
impl Bundle for ScanMoreInfo {
    ...
    fn parse(bitstream: &mut Bitstream, _: ()) -> Result<Self, Self::Error> {
        ...
        let extra_zero_runs = (0..num_extra_zero_runs)
            .map(|_| -> Result<_, crate::jxl_oxide_vendored::jxl_bitstream::Error> {
                let ExtraZeroRun {
                    num_runs,
                    run_length,
