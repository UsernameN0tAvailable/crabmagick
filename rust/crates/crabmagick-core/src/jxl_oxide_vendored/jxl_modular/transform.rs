...
use crate::jxl_oxide_vendored::jxl_modular::{Error, Result, Sample, image::TransformedGrid};
...
impl Bundle<&WpHeader> for TransformInfo {
    type Error = crate::jxl_oxide_vendored::jxl_modular::Error;

    fn parse(bitstream: &mut Bitstream, wp_header: &WpHeader) -> crate::jxl_oxide_vendored::jxl_modular::Result<Self> {
        ...
        match tr {
            ...
            value => Err(crate::jxl_oxide_vendored::jxl_modular::Error::Bitstream(crate::jxl_oxide_vendored::jxl_bitstream::Error::InvalidEnum {
                name: "TransformId",
                value,
            })),
        }
...
define_bundle! {
    #[derive(Debug, Clone)]
    pub struct Rct error(crate::jxl_oxide_vendored::jxl_modular::Error) {
        begin_c: ty(U32(u(3), 8 + u(6), 72 + u(10), 1096 + u(13))),
        rct_type: ty(U32(6, u(2), 2 + u(4), 10 + u(6))),
    }

    #[derive(Debug, Clone)]
    pub struct Squeeze error(crate::jxl_oxide_vendored::jxl_modular::Error) {
        num_sq: ty(U32(0, 1 + u(4), 9 + u(6), 41 + u(8))),
        sp: ty(Vec[Bundle(SqueezeParams)]; num_sq),
    }

    #[derive(Debug, Clone)]
    struct SqueezeParams error(crate::jxl_oxide_vendored::jxl_modular::Error) {
        horizontal: ty(Bool),
        in_place: ty(Bool),
        begin_c: ty(U32(u(3), 8 + u(6), 72 + u(10), 1096 + u(13))),
