...
use crate::jxl_oxide_vendored::jxl_oxide_common::define_bundle;

use crate::jxl_oxide_vendored::jxl_modular::Sample;

define_bundle! {
    #[derive(Debug, Clone)]
    pub struct WpHeader error(crate::jxl_oxide_vendored::jxl_modular::Error) {
...
impl TryFrom<u32> for Predictor {
    ...
    fn try_from(value: u32) -> crate::jxl_oxide_vendored::jxl_bitstream::BitstreamResult<Self> {
        use Predictor::*;
        Ok(match value {
            0 => Zero,
            1 => West,
