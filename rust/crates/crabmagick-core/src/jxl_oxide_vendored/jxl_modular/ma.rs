...
use crate::jxl_oxide_vendored::jxl_coding::Decoder;
...
use crate::jxl_oxide_vendored::jxl_modular::{Result, Sample, sample::Sealed};
...
impl Bundle<MaConfigParams<'_>> for MaConfig {
    ...
    fn parse(bitstream: &mut Bitstream, params: MaConfigParams) -> crate::jxl_oxide_vendored::jxl_modular::Result<Self> {
        ...
        if is_infinite_tree_dist(&tree_decoder) {
            ...
            return Err(crate::jxl_oxide_vendored::jxl_modular::Error::InvalidMaTree);
        }
        ...
        while nodes_left > 0 {
            ...
            if nodes.len() > node_limit {
                ...
                return Err(
                    crate::jxl_oxide_vendored::jxl_bitstream::Error::ProfileConformance("MA tree limit exceeded").into(),
                );
            }
