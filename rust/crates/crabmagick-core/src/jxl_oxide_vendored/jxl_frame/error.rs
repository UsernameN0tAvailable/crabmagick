...
pub enum Error {
    ...
    VarDct(crate::jxl_oxide_vendored::jxl_vardct::Error),
...
impl From<crate::jxl_oxide_vendored::jxl_vardct::Error> for Error {
    fn from(err: crate::jxl_oxide_vendored::jxl_vardct::Error) -> Self {
        Self::VarDct(err)
    }
}
...
impl Error {
    ...
    pub fn unexpected_eof(&self) -> bool {
        let bitstream_err = match self {
            Self::Bitstream(b)
            | Self::Decoder(crate::jxl_oxide_vendored::jxl_coding::Error::Bitstream(b))
            | Self::Modular(crate::jxl_oxide_vendored::jxl_modular::Error::Decoder(crate::jxl_oxide_vendored::jxl_coding::Error::Bitstream(b)))
            | Self::Modular(crate::jxl_oxide_vendored::jxl_modular::Error::Bitstream(b))
            | Self::VarDct(crate::jxl_oxide_vendored::jxl_vardct::Error::Bitstream(b))
            | Self::VarDct(crate::jxl_oxide_vendored::jxl_vardct::Error::Decoder(crate::jxl_oxide_vendored::jxl_coding::Error::Bitstream(b)))
            | Self::VarDct(crate::jxl_oxide_vendored::jxl_vardct::Error::Modular(crate::jxl_oxide_vendored::jxl_modular::Error::Bitstream(b)))
            | Self::VarDct(crate::jxl_oxide_vendored::jxl_vardct::Error::Modular(crate::jxl_oxide_vendored::jxl_modular::Error::Decoder(
                crate::jxl_oxide_vendored::jxl_coding::Error::Bitstream(b),
            ))) => b,
            _ => return false,
        };
        if let crate::jxl_oxide_vendored::jxl_bitstream::Error::Io(e) = bitstream_err {
