...
use crate::jxl_oxide_vendored::jxl_modular::{MaConfig, Sample, image::TransformedModularSubimage};
use crate::jxl_oxide_vendored::jxl_oxide_common::Bundle;
use crate::jxl_oxide_vendored::jxl_vardct::{HfMetadata, HfMetadataParams, LfCoeff, LfCoeffParams, Quantizer};
...
pub struct LfGroupParams<'a, 'dest, 'tracker, S: Sample> {
    ...
    pub pool: &'a crate::jxl_oxide_vendored::jxl_threadpool::JxlThreadPool,
}
