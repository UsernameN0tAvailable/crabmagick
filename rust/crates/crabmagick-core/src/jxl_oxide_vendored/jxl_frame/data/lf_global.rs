...
use crate::jxl_oxide_vendored::jxl_modular::{
...
use crate::jxl_oxide_vendored::jxl_vardct::{HfBlockContext, LfChannelCorrelation, LfChannelDequantization, Quantizer};

use crate::jxl_oxide_vendored::jxl_frame::{FrameHeader, Result, header::Encoding};
...
impl<S: Sample> Bundle<LfGlobalParams<'_, '_>> for LfGlobal<S> {
    ...
    fn parse(bitstream: &mut Bitstream, params: LfGlobalParams) -> Result<Self> {
        ...
        let vardct = (header.encoding == crate::jxl_oxide_vendored::jxl_frame::header::Encoding::VarDct)
        ...
        if let Some(splines) = &splines {
            ...
            if estimated_area > max_estimated_area {
                ...
                return Err(crate::jxl_oxide_vendored::jxl_bitstream::Error::ProfileConformance(
                    "too large estimated area for splines",
                )
                .into());
            }
...
define_bundle! {
    #[derive(Debug)]
    pub struct LfGlobalVarDct error(crate::jxl_oxide_vendored::jxl_frame::Error) {
