...
use crate::jxl_oxide_vendored::jxl_grid::SimdVector;
...
impl<'g, V> From<&'g crate::jxl_oxide_vendored::jxl_grid::AlignedGrid<V>> for SharedSubgrid<'g, V> {
    fn from(value: &'g crate::jxl_oxide_vendored::jxl_grid::AlignedGrid<V>) -> Self {
