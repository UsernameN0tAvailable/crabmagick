...
use crate::jxl_oxide_vendored::jxl_bitstream::ParseEvent;
use crate::jxl_oxide_vendored::jxl_bitstream::container::ContainerBoxType;

use crate::jxl_oxide_vendored::jxl_oxide::Result;
...
impl AuxBoxList {
    pub(crate) fn jbrd(&self) -> AuxBoxData<&crate::jxl_oxide_vendored::jxl_jbr::JpegBitstreamData> {
