...
use crate::jxl_oxide_vendored::jxl_render::{ImageBuffer, Region};
use private::Sealed;
...
impl<'r> ImageStream<'r> {
    pub(crate) fn from_render(render: &'r crate::jxl_oxide_vendored::jxl_oxide::Render, skip_alpha: bool) -> Self {
        use crate::jxl_oxide_vendored::jxl_image::ExtraChannelType;
