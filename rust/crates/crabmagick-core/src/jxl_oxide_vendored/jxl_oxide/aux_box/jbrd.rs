use crate::jxl_oxide_vendored::jxl_jbr::JpegBitstreamData;
...
impl Jbrd {
    ...
    pub fn feed_bytes(&mut self, bytes: &[u8]) -> crate::jxl_oxide_vendored::jxl_oxide::Result<()> {
        match self {
            Self::Uninit(buf) => {
    ...
    pub fn finalize(&mut self) -> crate::jxl_oxide_vendored::jxl_oxide::Result<()> {
        match self {
            Jbrd::Uninit(_) => Err(crate::jxl_oxide_vendored::jxl_jbr::Error::InvalidData.into()),
