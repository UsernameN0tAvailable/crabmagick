...
use crate::jxl_oxide_vendored::jxl_frame::{Frame, FrameContext, header::FrameType};
use crate::jxl_oxide_vendored::jxl_grid::AllocTracker;
use crate::jxl_oxide_vendored::jxl_image::{ImageHeader, ImageMetadata};
...
impl RenderContextBuilder {
    ...
    pub fn build(self, image_header: Arc<ImageHeader>) -> Result<RenderContext> {
        ...
        Ok(RenderContext {
            ...
            cms: Box::new(crate::jxl_oxide_vendored::jxl_color::NullCms),
    ...
    pub fn suggested_hdr_tf(&self) -> Option<TransferFunction> {
        let tf = match &self.image_header.metadata.colour_encoding {
            ...
            ColourEncoding::IccProfile(_) => {
                ...
                crate::jxl_oxide_vendored::jxl_color::icc::icc_tf(icc)?
            }
        };
    ...
    fn postprocess_keyframe(
        ...
        tracing::trace_span!("Transform to requested color encoding").in_scope(|| -> Result<_> {
            ...
            if frame_header.do_ycbcr {
                ...
                crate::jxl_oxide_vendored::jxl_color::ycbcr_to_rgb([cb.buf_mut(), y.buf_mut(), cr.buf_mut()]);
            }
