...
use crate::jxl_oxide_vendored::jxl_frame::{FrameHeader, data::NoiseParameters};
use crate::jxl_oxide_vendored::jxl_grid::{AlignedGrid, AllocTracker, SharedSubgrid};
use crate::jxl_oxide_vendored::jxl_threadpool::JxlThreadPool;

use crate::jxl_oxide_vendored::jxl_render::{ImageWithRegion, Region, Result};
...
struct NoiseGroup {
    ...
    height: usize,
    stride: usize,
    _alloc_handle: Option<crate::jxl_oxide_vendored::jxl_grid::AllocHandle>,
}
...
fn convolve_fill(
    mut out: crate::jxl_oxide_vendored::jxl_grid::MutableSubgrid<'_, f32>,
