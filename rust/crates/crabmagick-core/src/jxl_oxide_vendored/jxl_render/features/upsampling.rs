...
use crate::jxl_oxide_vendored::jxl_render::util::PaddedGrid;

pub fn upsample(
    grid: SharedSubgrid<f32>,
    out_region: &mut Region,
    image_header: &crate::jxl_oxide_vendored::jxl_image::ImageHeader,
    factor: u32,
    tracker: Option<&AllocTracker>,
) -> crate::jxl_oxide_vendored::jxl_render::Result<Option<AlignedGrid<f32>>> {
...
fn upsample_inner<const K: usize, const NW: usize>(
    ...
    weights: &[f32; NW],
    tracker: Option<&AllocTracker>,
) -> crate::jxl_oxide_vendored::jxl_render::Result<AlignedGrid<f32>> {
