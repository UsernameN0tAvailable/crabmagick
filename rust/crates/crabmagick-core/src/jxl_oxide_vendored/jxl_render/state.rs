...
use crate::jxl_oxide_vendored::jxl_frame::data::{HfGlobal, LfGlobal, LfGroup};
...
impl<S: Sample> RenderCache<S> {
    pub fn new(frame: &crate::jxl_oxide_vendored::jxl_render::IndexedFrame) -> Self {
...
pub enum FrameRender<S: Sample> {
    ...
    Err(crate::jxl_oxide_vendored::jxl_render::Error),
    ErrTaken,
}
