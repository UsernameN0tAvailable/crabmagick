...
use crate::jxl_oxide_vendored::jxl_modular::{Sample, image::TransformedModularSubimage};

use crate::jxl_oxide_vendored::jxl_render::{Error, ImageWithRegion, IndexedFrame, Region, RenderCache, Result, util};
        ...
        pool.scope(|scope| {
            ...
            pool.for_each_vec(
                ...
                |PassGroupJob {
                    ...
                    let result = &result;
                    let r = crate::jxl_oxide_vendored::jxl_frame::data::decode_pass_group_modular(
                        &mut bitstream,
                        frame_header,
                        global_ma_config,
                        pass_idx,
