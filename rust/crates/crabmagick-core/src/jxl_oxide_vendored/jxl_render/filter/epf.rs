...
use crate::jxl_oxide_vendored::jxl_frame::{FrameHeader, data::LfGroup, filter::EpfParams};
...
use crate::jxl_oxide_vendored::jxl_render::{ImageWithRegion, Region, util};
...
pub fn apply_epf<S: Sample>(
    ...
    if iters == 1 || iters == 3 {
        ...
        for (idx, grid) in fb_scratch_arr.into_iter().enumerate() {
            ...
            fb_image.replace_channel(idx, crate::jxl_oxide_vendored::jxl_render::ImageBuffer::F32(grid), region);
        }
    }
}
