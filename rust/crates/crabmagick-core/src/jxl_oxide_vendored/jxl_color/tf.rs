...
pub fn apply_gamma(samples: &mut [f32], gamma: f32) {
        ...
        if std::arch::is_aarch64_feature_detected!("neon") {
            ...
            for chunk in &mut it {
                unsafe {
                    ...
                    let exp = crate::jxl_oxide_vendored::jxl_color::fastmath::fast_powf_aarch64_neon(v, gamma);
    ...
    for x in samples {
        ...
        *x = if a <= 1e-7 {
            ...
            crate::jxl_oxide_vendored::jxl_color::fastmath::fast_powf_generic(a, gamma)
        };
    }
}
...
unsafe fn linear_to_gamma_x86_64_avx2(samples: &mut [f32], gamma: f32) -> &mut [f32] {
    ...
    for chunk in &mut it {
        ...
        let exp = crate::jxl_oxide_vendored::jxl_color::fastmath::fast_powf_x86_64_avx2(v, _mm256_set1_ps(gamma));
    ...
    let exp = crate::jxl_oxide_vendored::jxl_color::fastmath::fast_powf_x86_64_fma(v, _mm_set1_ps(gamma));
