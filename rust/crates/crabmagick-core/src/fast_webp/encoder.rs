...
mod tests {
    ...
    fn write_webp() {
        ...
        WebPEncoder::new(&mut output)
            .encode(&img, 256, 256, crate::fast_webp::ColorType::Rgba8)
            .unwrap();

        let mut decoder = crate::fast_webp::WebPDecoder::new(std::io::Cursor::new(output)).unwrap();
    ...
    fn write_webp_exif() {
        ...
        encoder
            .encode(&img, 256, 256, crate::fast_webp::ColorType::Rgb8)
            .unwrap();
    ...
    fn roundtrip_libwebp_params(params: EncoderParams) {
        ...
        encoder
            .encode(&img[..256 * 256 * 3], 256, 256, crate::fast_webp::ColorType::Rgb8)
            .unwrap();
