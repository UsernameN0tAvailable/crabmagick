...
use crate::jpeg2000_decode::error::{MarkerError, Result, ValidationError, bail, err};
...
fn size_marker(reader: &mut BitReader<'_>) -> Result<SizeData> {
    ...
    {
        bail!(crate::jpeg2000_decode::TileError::InvalidOffsets);
    }
    ...
    if size_data
        ...
        .ok_or(crate::jpeg2000_decode::TileError::InvalidOffsets)?
