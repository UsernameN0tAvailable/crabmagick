...
use crate::jpeg2000_decode::error::{FormatError, Result, bail};
use crate::jpeg2000_decode::j2c::ComponentData;
use crate::jpeg2000_decode::jp2::r#box::{FILE_TYPE, JP2_SIGNATURE};
use crate::jpeg2000_decode::jp2::cdef::ChannelDefinitionBox;
use crate::jpeg2000_decode::jp2::cmap::{ComponentMappingBox, ComponentMappingEntry, ComponentMappingType};
use crate::jpeg2000_decode::jp2::colr::ColorSpecificationBox;
use crate::jpeg2000_decode::jp2::pclr::PaletteBox;
use crate::jpeg2000_decode::reader::BitReader;
use crate::jpeg2000_decode::{DecodeSettings, Image, resolve_alpha_and_color_space};
    ...
    while !reader.at_end() {
        ...
        match current_box.box_type {
            ...
            r#box::CONTIGUOUS_CODESTREAM => {
                parsed_codestream = Some(crate::jpeg2000_decode::j2c::parse_raw(current_box.data, &settings)?);
            }
            _ => {}
        }
    }
