//! Simple public decode API for JPEG 2000 decoder.

use alloc::vec::Vec;

use crate::jpeg2000_decode::error::{DecodeError, FormatError};
...
pub(crate) fn decode(data: &[u8]) -> Result<DecodedImage, DecodeError> {
    ...
    if !signature.starts_with(crate::jpeg2000_decode::JP2_MAGIC) && !signature.starts_with(crate::jpeg2000_decode::CODESTREAM_MAGIC) {
