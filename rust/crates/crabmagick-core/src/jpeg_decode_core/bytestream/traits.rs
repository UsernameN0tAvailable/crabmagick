...
use crate::jpeg_decode_core::bytestream::reader::{ZByteIoError, ZSeekFrom};
...
/// # Considerations
///
/// If you have an in memory buffer, prefer [`ZCursor`](crate::jpeg_decode_core::bytestream::ZCursor) over [`Cursor`](std::io::Cursor).
...
/// [`read_byte_no_error`](crate::jpeg_decode_core::bytestream::ZByteReaderTrait::read_byte_no_error) are slower than they should be for `Cursor`.
///
