...
//! handling in memory buffers by using [`ZCursor`](crate::jpeg_decode_core::bytestream::ZCursor).
//!
...
//!
//! If you have an in memory buffer, use [`ZCursor`](crate::jpeg_decode_core::bytestream::ZCursor),
