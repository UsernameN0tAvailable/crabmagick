...
use crate::zenjpeg::huffman::classic::{
...
impl OptimizedTable {
    ...
    pub fn from_bits_values(bits: [u8; 16], values: Vec<u8>) -> crate::zenjpeg::error::Result<Self> {
...
impl HuffmanTableSet {
    ...
    ///
    /// Alias: [`Self::annex_k()`].
    pub fn from_standard() -> crate::zenjpeg::error::Result<Self> {
        use crate::zenjpeg::huffman::encode::{
    ...
    pub fn annex_k() -> crate::zenjpeg::error::Result<Self> {
        Self::from_standard()
    }
}
...
impl FrequencyCounter {
    ...
    pub fn generate_table_with_method(
        ...
        use crate::zenjpeg::types::HuffmanMethod;
        ...
        match method {
            HuffmanMethod::JpegliCreateTree => {
                ...
                let depths = crate::zenjpeg::huffman::build_code_lengths(&freqs, 16);
