...
pub fn encode_block_to_writer(
    coeffs: &[i16; 64],
    dc_table: &crate::zenjpeg::huffman::HuffmanEncodeTable,
    ac_table: &crate::zenjpeg::huffman::HuffmanEncodeTable,
    prev_dc: i16,
    writer: &mut crate::zenjpeg::foundation::bitstream::BitWriter,
...
pub fn encode_blocks_mcu_order(
    ...
    subsampling: crate::zenjpeg::types::Subsampling,
    width: usize,
