...
use crate::zenjpeg::encode::encoder_config::EncoderConfig;
use crate::zenjpeg::encode::encoder_types::{ChromaSubsampling, PixelLayout, Quality};
use crate::zenjpeg::encode::exif::Exif;
...
impl JpegEncoderConfig {
    ...
    ///
    /// Requires the `trellis` feature (uses [`ExpertConfig`](crate::zenjpeg::encode::search::ExpertConfig)).
    #[cfg(feature = "trellis")]
    #[must_use]
    pub fn from_preset(preset_name: &str, quality: f32) -> Option<Self> {
        use crate::zenjpeg::encode::encoder_types::OptimizationPreset;
        use crate::zenjpeg::encode::search::ExpertConfig;
        ...
        let color_mode = crate::zenjpeg::encode::encoder_types::ColorMode::YCbCr {
        ...
        #[cfg(feature = "parallel")]
        {
            ...
            match self.limits.threading {
                ...
                ThreadingPolicy::LimitOrSingle { max_threads } => {
                    if max_threads > 1 {
                        cfg = cfg.parallel(crate::zenjpeg::encode::ParallelEncoding::Auto);
                    }
                }
...
pub struct JpegEncoder {
    ...
    streaming_enc: Option<crate::zenjpeg::encode::byte_encoders::BytesEncoder>,
...
impl JpegEncoder {
    ...
    fn build_request(&self) -> crate::zenjpeg::encode::request::EncodeRequest<'_> {
    ...
    ) -> crate::zenjpeg::encode::request::EncodeRequest<'b> {
...
///
/// Wraps [`crate::zenjpeg::decode::DecodeConfig`] with the zencodec trait interface.
#[derive(Clone, Debug)]
pub struct JpegDecoderConfig {
    #[cfg(feature = "decoder")]
    inner: crate::zenjpeg::decode::DecodeConfig,
    #[allow(dead_code)]
    limits: ResourceLimits,
}
...
impl JpegDecoderConfig {
    ...
    pub fn new() -> Self {
        Self {
            #[cfg(feature = "decoder")]
            inner: crate::zenjpeg::decode::DecodeConfig::new(),
            limits: ResourceLimits::none(),
        }
    }
    ...
    /// Access the underlying [`DecodeConfig`](crate::zenjpeg::decode::DecodeConfig).
    #[cfg(feature = "decoder")]
    #[must_use]
    pub fn inner(&self) -> &crate::zenjpeg::decode::DecodeConfig {
        &self.inner
    }

    /// Mutable access to the underlying [`DecodeConfig`](crate::zenjpeg::decode::DecodeConfig).
    #[cfg(feature = "decoder")]
    pub fn inner_mut(&mut self) -> &mut crate::zenjpeg::decode::DecodeConfig {
        &mut self.inner
    }

    /// Enable post-decode deblocking to reduce JPEG block artifacts.
    ///
    /// Delegates to [`DecodeConfig::deblock()`](crate::zenjpeg::decode::DecodeConfig::deblock).
    /// See [`DeblockMode`](crate::zenjpeg::decode::DeblockMode) for available modes.
    #[cfg(feature = "decoder")]
    #[must_use]
    pub fn deblock(mut self, mode: crate::zenjpeg::decode::DeblockMode) -> Self {
...
impl<'a> zencodec::decode::DecodeJob<'a> for JpegDecodeJob {
    ...
    fn probe(&self, data: &[u8]) -> Result<ImageInfo, Self::Error> {
        #[cfg(feature = "decoder")]
        {
            ...
            if let Ok(probe) = crate::zenjpeg::detect::probe(data) {
    ...
    fn output_info(&self, data: &[u8]) -> Result<OutputInfo, Self::Error> {
        #[cfg(feature = "decoder")]
        {
            ...
            if will_orient
                ...
                && let Some(orient_val) = crate::zenjpeg::lossless::parse_exif_orientation(exif)
            {
...
impl JpegDecodeJob {
    ...
    #[cfg(feature = "decoder")]
    fn check_progressive_policy(&self, mode: crate::zenjpeg::types::JpegMode) -> Result<(), Error> {
        if let Some(ref policy) = self.policy {
            let is_progressive = matches!(
                mode,
                crate::zenjpeg::types::JpegMode::Progressive | crate::zenjpeg::types::JpegMode::ArithmeticProgressive
            );
...
fn build_decode_config(
    ...
    orientation: zencodec::OrientationHint,
    policy: Option<&zencodec::decode::DecodePolicy>,
) -> crate::zenjpeg::decode::DecodeConfig {
    ...
    if let Some((x, y, w, h)) = crop_hint {
        cfg = cfg.crop(crate::zenjpeg::decode::CropRegion::pixels(x, y, w, h));
    }
    ...
    if let Some(pol) = policy {
        ...
        let mut preserve = crate::zenjpeg::decode::PreserveConfig::all();
        if let Some(false) = pol.allow_icc {
            preserve = preserve.icc(crate::zenjpeg::decode::IccPreserve::None);
        }
...
impl zencodec::decode::Decode for JpegDecoder<'_> {
    ...
    fn decode(self) -> Result<DecodeOutput, Error> {
        #[cfg(feature = "decoder")]
        {
            use crate::zenjpeg::decode::OutputTarget;
            ...
            if needs_header {
                ...
                let is_progressive = matches!(
                    header.mode,
                    crate::zenjpeg::types::JpegMode::Progressive
                        | crate::zenjpeg::types::JpegMode::ArithmeticProgressive
                );
                if let Some(ref policy) = self.policy
                    && is_progressive
            ...
            if let Some(extras) = result.extras() {
                ...
                if let Some(exif) = extras.exif() {
                    if let Some(orient) = crate::zenjpeg::lossless::parse_exif_orientation(exif) {
...
pub struct JpegStreamingDecoder<'a> {
    #[cfg(feature = "decoder")]
    reader: crate::zenjpeg::decode::ScanlineReader<'a>,
    info: ImageInfo,
    descriptor: PixelDescriptor,
...
#[cfg(feature = "decoder")]
fn to_image_info(info: &crate::zenjpeg::decode::JpegInfo) -> ImageInfo {
...
#[cfg(feature = "decoder")]
fn source_color_from_header(info: &crate::zenjpeg::decode::JpegInfo) -> zencodec::decode::SourceColor {
...
fn decode_descriptor(
    preferred: &[PixelDescriptor],
    header: &crate::zenjpeg::decode::JpegInfo,
    correct_color: Option<&crate::zenjpeg::color::icc::TargetColorSpace>,
) -> PixelDescriptor {
...
#[cfg(feature = "decoder")]
fn jfif_to_resolution(jfif: &crate::zenjpeg::encode::extras::JfifInfo) -> Option<zencodec::Resolution> {
    use crate::zenjpeg::encode::extras::DensityUnits;
