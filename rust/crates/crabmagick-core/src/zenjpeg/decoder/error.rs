...
//! - [`ArgumentError`](crate::zenjpeg::error::ArgumentError) - Invalid arguments
//! - [`ResourceError`](crate::zenjpeg::error::ResourceError) - Memory/IO failures
...
pub use crate::zenjpeg::error::{ArgumentError, ResourceError};
...
impl From<crate::zenjpeg::error::Error> for Error {
    #[track_caller]
    fn from(err: crate::zenjpeg::error::Error) -> Self {
        use crate::zenjpeg::error::ErrorKind as EK;
