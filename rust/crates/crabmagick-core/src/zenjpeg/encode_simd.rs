...
pub fn rgb_to_ycbcr_strided_inplace(
    ...
    #[cfg(feature = "yuv")]
    {
        crate::zenjpeg::color::fast_yuv::rgb_to_ycbcr_strided_fast(
...
pub fn rgb_to_ycbcr_strided_reuse(
    ...
    crate::zenjpeg::color::fast_yuv::rgb_to_ycbcr_strided_reuse(
        rgb_data,
        y_plane,
        cb_plane,
        cr_plane,
...
pub fn bgr_to_ycbcr_strided_reuse(
    ...
    crate::zenjpeg::color::fast_yuv::bgr_to_ycbcr_strided_reuse(
        bgr_data,
        y_plane,
        cb_plane,
        cr_plane,
...
pub fn bgr_to_ycbcr_strided_inplace(
    ...
    #[cfg(feature = "yuv")]
    {
        crate::zenjpeg::color::fast_yuv::bgr_to_ycbcr_strided_fast(
