...
///
/// When [`Decoder::correct_color`](crate::zenjpeg::decode::Decoder::correct_color) is set
...
pub fn is_xyb_profile(icc_data: &[u8]) -> bool {
    ...
    use crate::zenjpeg::foundation::consts::XYB_ICC_PROFILE;
...
mod tests {
    ...
    fn test_is_xyb_profile() {
        ...
        assert!(is_xyb_profile(&crate::zenjpeg::foundation::consts::XYB_ICC_PROFILE));
