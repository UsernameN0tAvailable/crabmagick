...
use crate::zenjpeg::foundation::aligned_alloc::{AlignedVec, AllocError, try_alloc_zeroed};
...
impl AQStrengthMap {
    ...
    ///
    /// This value can be used with [`crate::zenjpeg::encode::trellis::should_use_hybrid`]
