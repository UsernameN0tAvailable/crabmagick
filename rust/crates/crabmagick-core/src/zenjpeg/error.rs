...
//! - Decoder-specific errors in [`crate::zenjpeg::decoder::error`]
//! - Encoder-specific errors in [`crate::zenjpeg::encoder::error`]
...
pub enum ArgumentError {
    ...
    UnsupportedPixelFormat { format: crate::zenjpeg::types::PixelFormat },
}
...
impl Error {
    ...
    #[track_caller]
    pub fn unsupported_pixel_format(format: crate::zenjpeg::types::PixelFormat) -> Self {
...
impl From<crate::zenjpeg::foundation::aligned_alloc::AllocError> for Error {
    #[track_caller]
    fn from(err: crate::zenjpeg::foundation::aligned_alloc::AllocError) -> Self {
        match err {
            crate::zenjpeg::foundation::aligned_alloc::AllocError::OutOfMemory => {
                Self::allocation_failed(0, "adaptive quantization")
            }
            crate::zenjpeg::foundation::aligned_alloc::AllocError::Overflow => {
