...
impl From<crate::zenjpeg::encode::encoder_types::ChromaSubsampling> for Subsampling {
    fn from(cs: crate::zenjpeg::encode::encoder_types::ChromaSubsampling) -> Self {
...
impl From<Subsampling> for crate::zenjpeg::encode::encoder_types::ChromaSubsampling {
...
impl From<crate::zenjpeg::encode::encoder_types::PixelLayout> for PixelFormat {
    fn from(layout: crate::zenjpeg::encode::encoder_types::PixelLayout) -> Self {
...
impl QuantTable {
    ...
    pub fn from_natural_order(values: &[u16; DCT_BLOCK_SIZE]) -> Self {
        ...
        for (i, &v) in values.iter().enumerate() {
            let zi = crate::zenjpeg::foundation::consts::JPEG_ZIGZAG_ORDER[i] as usize;
            zigzag[zi] = v;
        }
        Self {
            values: zigzag,
    ...
    pub fn to_natural_order(&self) -> [u16; DCT_BLOCK_SIZE] {
        ...
        for (i, &zi) in crate::zenjpeg::foundation::consts::JPEG_NATURAL_ORDER[..DCT_BLOCK_SIZE]
            .iter()
            .enumerate()
        {
