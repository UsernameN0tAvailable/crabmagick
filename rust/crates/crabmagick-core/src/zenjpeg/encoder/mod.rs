...
// types we re-export from crate::zenjpeg::encode use them internally.
// === Error types ===
/// Errors that can occur during JPEG encoding.
pub type EncodeError = crate::zenjpeg::error::Error;
...
pub use crate::zenjpeg::encode::Stop;
pub use crate::zenjpeg::encode::byte_encoders::{BytesEncoder, Pixel, RgbEncoder, YCbCrPlanarEncoder};
pub use crate::zenjpeg::encode::encoder_config::EncoderConfig;
pub use crate::zenjpeg::encode::encoder_types::{
...
pub use crate::zenjpeg::encode::exif::{Exif, ExifFields, Orientation};
pub use crate::zenjpeg::encode::request::EncodeRequest;
pub use crate::zenjpeg::foundation::alloc::EncodeStats;
pub use crate::zenjpeg::types::Limits;
...
#[doc(hidden)]
pub use crate::zenjpeg::encode::tables;

#[cfg(feature = "parallel")]
pub use crate::zenjpeg::encode::encoder_types::ParallelEncoding;

// === mozjpeg-compatible quantization tables ===
pub use crate::zenjpeg::encode::tables::presets::{MozjpegTables, QuantTablePreset};
...
pub use crate::zenjpeg::huffman::optimize::HuffmanTableSet;
pub use crate::zenjpeg::types::HuffmanMethod;
