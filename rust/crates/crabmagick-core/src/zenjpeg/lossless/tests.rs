...
mod pipeline_tests {
    use crate::zenjpeg::decode::DecodeConfig;
    use crate::zenjpeg::lossless::{EdgeHandling, LosslessTransform, TransformConfig, transform};
    use enough::Unstoppable;

    /// Create a test JPEG from a known pixel pattern using zenjpeg encoder.
    fn create_test_jpeg(width: u32, height: u32) -> Vec<u8> {
        use crate::zenjpeg::encoder::{ChromaSubsampling, EncoderConfig, PixelLayout};
...
mod exif_tests {
    use crate::zenjpeg::lossless::coeff_transform::LosslessTransform;
    use crate::zenjpeg::lossless::exif::{parse_exif_orientation, set_exif_orientation};
    ...
    fn test_apply_exif_orientation_no_exif() {
        ...
        use crate::zenjpeg::encoder::{ChromaSubsampling, EncoderConfig, PixelLayout};
        use crate::zenjpeg::lossless::apply_exif_orientation;
        use enough::Unstoppable;
    ...
    fn test_apply_exif_orientation_normal() {
        ...
        use crate::zenjpeg::encoder::{ChromaSubsampling, EncoderConfig, Exif, Orientation, PixelLayout};
        use crate::zenjpeg::lossless::apply_exif_orientation;
        use enough::Unstoppable;
...
fn encode_test_image(
    ...
    h: u32,
    pixels: &[u8],
    orientation: Option<crate::zenjpeg::encoder::Orientation>,
) -> Vec<u8> {
    use crate::zenjpeg::encoder::{ChromaSubsampling, EncoderConfig, Exif, PixelLayout};
    use enough::Unstoppable;
...
fn decode_test(jpeg: &[u8], config: &crate::zenjpeg::decode::DecodeConfig) -> (u32, u32, Vec<u8>) {
    use enough::Unstoppable;
...
fn scanline_decode_test(jpeg: &[u8], config: &crate::zenjpeg::decode::DecodeConfig) -> (u32, u32, Vec<u8>) {
    use imgref::ImgRefMut;
...
fn test_auto_orient_all_orientations() {
    use crate::zenjpeg::decode::DecodeConfig;
    use crate::zenjpeg::encoder::Orientation;
...
mod restructure_tests {
    ...
    fn create_test_jpeg_gray(width: u32, height: u32) -> Vec<u8> {
        use crate::zenjpeg::encoder::{EncoderConfig, PixelLayout};
    ...
    fn test_restructure_preserves_metadata() {
        ...
        let decoder = DecodeConfig::new().preserve(crate::zenjpeg::decode::PreserveConfig::all());
