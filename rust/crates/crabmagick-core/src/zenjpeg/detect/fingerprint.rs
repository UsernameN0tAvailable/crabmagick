...
use crate::zenjpeg::foundation::consts::MARKER_SOF0;
use crate::zenjpeg::quant::{STD_CHROMINANCE_QUANT, STD_LUMINANCE_QUANT};
...
mod tests {
    ...
    fn test_robidoux_luma_chroma_identical() {
        ...
        use crate::zenjpeg::encode::tables::robidoux::{ROBIDOUX_CHROMINANCE, ROBIDOUX_LUMINANCE};
