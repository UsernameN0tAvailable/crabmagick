...
use crate::zenjpeg::lossless::{BlockTransform, LosslessTransform, remap_block};
...
impl<'a> JpegParser<'a> {
    ...
    pub(in crate::zenjpeg::decode) fn apply_dct_transform(&mut self, transform: LosslessTransform) {
