...
use crate::zenjpeg::foundation::alloc::{checked_size_2d, try_alloc_dct_blocks, try_alloc_maybeuninit};
...
use crate::zenjpeg::color::ycbcr_planes_i16_to_rgb_u8;
...
impl<'a> JpegParser<'a> {
    ...
    pub(super) fn parse_scan(&mut self, stop: &impl Stop) -> Result<()> {
        ...
        if num_components > crate::zenjpeg::foundation::consts::MAX_COMPONENTS as u8 {
    ...
    pub(super) fn decode_baseline_streaming(
        ...
        fn decode_mcu_row(
            ...
            scan_components: &[(usize, u8, u8)],
            components: &[crate::zenjpeg::types::Component; crate::zenjpeg::foundation::consts::MAX_COMPONENTS],
            mcu_cols: usize,
            mcu_count: &mut u32,
