...
use crate::zenjpeg::color::icc::{extract_icc_profile, is_xyb_profile};
use crate::zenjpeg::error::{Error, ErrorKind, Result};
use crate::zenjpeg::foundation::alloc::{MAX_SCANS, checked_size_2d};
...
use crate::zenjpeg::types::{ColorSpace, Component, Dimensions, JpegMode};
use enough::Stop;
...
impl<'a> JpegParser<'a> {
    ...
    pub(super) fn extract_coefficients(&self) -> Result<crate::zenjpeg::decode::image::DecodedCoefficients> {
        use crate::zenjpeg::decode::image::{ComponentCoefficients, DecodedCoefficients};
