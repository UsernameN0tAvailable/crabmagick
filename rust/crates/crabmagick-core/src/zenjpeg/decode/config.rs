...
use crate::zenjpeg::color::icc::TargetColorSpace;
use crate::zenjpeg::foundation::alloc::{DEFAULT_MAX_MEMORY, DEFAULT_MAX_PIXELS};
use crate::zenjpeg::lossless::LosslessTransform;
use crate::zenjpeg::types::Dimensions;
...
///
/// `Auto` uses [`detect::content::recommend_deblock()`](crate::zenjpeg::detect::content::recommend_deblock)
...
impl CropRegion {
    ...
    pub(crate) fn resolve(
        ...
        img_h: u32,
        mcu_height: usize,
    ) -> crate::zenjpeg::error::Result<ResolvedCrop> {
        let (x, y, w, h) = match self {
            ...
            CropRegion::Percent {
                ...
                {
                    return Err(crate::zenjpeg::error::Error::invalid_jpeg_data(
...
pub struct DecodeConfig {
    ...
    pub output_format: Option<crate::zenjpeg::types::PixelFormat>,
...
pub struct DecodeResult {
    ...
    pub format: crate::zenjpeg::types::PixelFormat,
...
impl DecodeResult {
    ...
    pub(crate) fn new_u8(
        width: u32,
        height: u32,
        format: crate::zenjpeg::types::PixelFormat,
        output_target: OutputTarget,
        pixels: Vec<u8>,
    ...
    /// Pixel format of the decoded data.
    #[must_use]
    pub fn format(&self) -> crate::zenjpeg::types::PixelFormat {
        self.format
    }
    ...
    pub fn into_parts(
        ...
        u32,
        u32,
        crate::zenjpeg::types::PixelFormat,
...
pub struct JpegInfo {
    ...
    /// Color space
    pub color_space: crate::zenjpeg::types::ColorSpace,
    /// Sample precision (8 or 12 bits)
    pub precision: u8,
    /// Number of components
    pub num_components: u8,
    /// Encoding mode
    pub mode: crate::zenjpeg::types::JpegMode,
    /// Chroma subsampling mode
    pub subsampling: crate::zenjpeg::types::Subsampling,
    ...
    pub jfif: Option<crate::zenjpeg::encode::extras::JfifInfo>,
}
