...
pub use crate::zenjpeg::encode::extras::{
...
impl DecodedExtras {
    ...
    /// ```
    #[must_use]
    pub fn to_encoder_segments(&self) -> crate::zenjpeg::encode::extras::EncoderSegments {
    ...
    pub fn to_encoder_segments_filtered<F>(
        &self,
        filter: F,
    ) -> crate::zenjpeg::encode::extras::EncoderSegments
    where
