...
use crate::zenjpeg::types::{EdgePaddingConfig, JpegMode, PixelFormat, Subsampling};
...
/// It combines dimension-independent settings from [`crate::zenjpeg::encode::EncoderConfig`]
...
pub struct ComputedConfig {
    ...
    pub custom_aq_map: Option<crate::zenjpeg::quant::aq::AQStrengthMap>,

    /// Custom encoding tables (escape hatch for experimentation).
    /// Not part of public API.
    #[doc(hidden)]
    pub(crate) encoding_tables: Option<Box<crate::zenjpeg::encode::tuning::EncodingTables>>,
