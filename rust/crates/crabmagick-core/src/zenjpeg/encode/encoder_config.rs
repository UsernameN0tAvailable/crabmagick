...
use crate::zenjpeg::types::EdgePaddingConfig;
...
impl EncoderConfig {
    ...
    #[doc(hidden)]
    #[must_use]
    pub fn custom_huffman_tables(self, tables: crate::zenjpeg::huffman::optimize::HuffmanTableSet) -> Self {
        self.huffman(tables)
    }
    ...
    pub fn validate(&self) -> Result<()> {
        if self.scan_mode.is_progressive() && !matches!(self.huffman, HuffmanStrategy::Optimize) {
            return Err(crate::zenjpeg::error::Error::invalid_config(
    ...
    pub fn estimate_memory(&self, width: u32, height: u32) -> usize {
        use crate::zenjpeg::encode::streaming::StreamingEncoder;

        let subsampling = match self.color_mode {
            ColorMode::YCbCr { subsampling } => subsampling.into(),
            ColorMode::Xyb { .. } => crate::zenjpeg::types::Subsampling::S444,
            ColorMode::Grayscale => crate::zenjpeg::types::Subsampling::S444,
        };
...
mod tests {
    use super::*;
    #[cfg(feature = "trellis")]
    use crate::zenjpeg::encode::trellis::TrellisSpeedMode;
    ...
    fn test_optimization_preset_jpegli_baseline() {
        use crate::zenjpeg::encode::encoder_types::{
    ...
    fn test_optimization_preset_overridable() {
        use crate::zenjpeg::encode::encoder_types::{OptimizationPreset, ProgressiveScanMode};
    ...
    fn test_progressive_accepts_bool_and_enum() {
        use crate::zenjpeg::encode::encoder_types::ProgressiveScanMode;
    ...
    fn test_quant_table_config_custom() {
        use crate::zenjpeg::encode::encoder_types::QuantTableConfig;
        let tables = crate::zenjpeg::encode::tuning::EncodingTables::default_ycbcr();
    ...
    fn test_effort_constructors_fast() {
        use crate::zenjpeg::encode::encoder_types::Effort;
    ...
    fn encode_test_image(config: &EncoderConfig) -> Vec<u8> {
        use crate::zenjpeg::encode::encoder_types::PixelLayout;
