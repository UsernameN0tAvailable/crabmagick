...
use crate::zenjpeg::entropy::{self, EntropyEncoder};
...
use crate::zenjpeg::huffman::optimize::{FrequencyCounter, HuffmanTableSet};
...
impl HuffmanSymbolFrequencies {
    ...
    pub fn generate_tables(&self) -> Result<HuffmanTableSet> {
        self.generate_tables_with_method(crate::zenjpeg::types::HuffmanMethod::JpegliCreateTree)
    }

    /// Generates a `HuffmanTableSet` using the specified algorithm.
    pub fn generate_tables_with_method(
        &self,
        method: crate::zenjpeg::types::HuffmanMethod,
        ...
        let (dc_chroma, ac_chroma) = if self.dc_chroma.is_empty_histogram() {
            use crate::zenjpeg::huffman::optimize::OptimizedTable;
...
impl ComputedConfig {
    ...
    pub(crate) fn build_optimized_tables_xyb_raster(
        ...
        crate::zenjpeg::huffman::optimize::OptimizedTable,
        crate::zenjpeg::huffman::optimize::OptimizedTable,
    )> {
        ...
        let huffman_method = crate::zenjpeg::types::HuffmanMethod::JpegliCreateTree;
    ...
    pub(crate) fn encode_with_tables_xyb_raster(
        ...
        y_blocks: &[[i16; DCT_BLOCK_SIZE]],
        b_blocks: &[[i16; DCT_BLOCK_SIZE]],
        dc_table: &crate::zenjpeg::huffman::optimize::OptimizedTable,
        ac_table: &crate::zenjpeg::huffman::optimize::OptimizedTable,
    ) -> Result<Vec<u8>> {
        let width = self.width as usize;
        let height = self.height as usize;
