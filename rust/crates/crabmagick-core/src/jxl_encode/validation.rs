...
//! [`crate::jxl_encode::api::LossyConfig::validate`] /
//! [`crate::jxl_encode::api::LosslessConfig::validate`] (and, with the `__expert` cargo
//! feature, [`crate::jxl_encode::effort::LossyInternalParams::validate`] /
//! [`crate::jxl_encode::effort::LosslessInternalParams::validate`]) before invoking
//! the encoder.
//!
...
/// Validate the per-knob ranges of a resolved [`crate::jxl_encode::effort::EffortProfile`]
/// for the fields that [`crate::jxl_encode::effort::LossyInternalParams`] exposes.
#[cfg(feature = "__expert")]
...
/// Validate the per-knob ranges of a resolved [`crate::jxl_encode::effort::EffortProfile`]
/// for the fields that [`crate::jxl_encode::effort::LosslessInternalParams`] exposes.
#[cfg(feature = "__expert")]
...
impl crate::jxl_encode::api::LossyConfig {
    ...
    /// [`crate::jxl_encode::effort::LossyInternalParams::validate`] would enforce.
...
impl crate::jxl_encode::api::LosslessConfig {
    /// Validate that every parameter on this config is within the encoder's
    /// supported range.
    ///
    /// See [`crate::jxl_encode::api::LossyConfig::validate`] for the contract.
    pub fn validate(&self) -> Result<(), ValidationError> {
        check_effort(self.effort())?;
...
#[cfg(feature = "__expert")]
impl crate::jxl_encode::effort::LossyInternalParams {
    /// Validate every `Some(_)` field against the same ranges
    /// [`crate::jxl_encode::api::LossyConfig::validate`] enforces on the resolved
    /// profile. Use this to fail fast on a freshly-constructed
    /// `LossyInternalParams` before passing it to
    /// [`crate::jxl_encode::api::LossyConfig::with_internal_params`].
    pub fn validate(&self) -> Result<(), ValidationError> {
...
#[cfg(feature = "__expert")]
impl crate::jxl_encode::effort::LosslessInternalParams {
    /// Validate every `Some(_)` field against the same ranges
    /// [`crate::jxl_encode::api::LosslessConfig::validate`] enforces on the resolved
    /// profile.
    pub fn validate(&self) -> Result<(), ValidationError> {
