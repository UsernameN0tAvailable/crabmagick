...
impl From<crate::jxl_encode::error::Error> for EncodeError {
    fn from(e: crate::jxl_encode::error::Error) -> Self {
        match e {
            crate::jxl_encode::error::Error::InvalidImageDimensions(w, h) => Self::InvalidInput {
                message: format!("invalid dimensions: {w}x{h}"),
            },
            crate::jxl_encode::error::Error::ImageTooLarge(w, h, mw, mh) => Self::LimitExceeded {
                message: format!("image {w}x{h} exceeds max {mw}x{mh}"),
            },
            crate::jxl_encode::error::Error::DimensionOverflow {
                width,
                height,
                channels,
            } => Self::InvalidInput {
            ...
            crate::jxl_encode::error::Error::Cancelled => Self::Cancelled,
            other => Self::Internal {
...
pub struct LosslessConfig {
    ...
    profile_override: Option<crate::jxl_encode::effort::EffortProfile>,
}
...
impl LosslessConfig {
    ...
    /// [`crate::jxl_encode::effort::LosslessInternalParams`] overrides the corresponding
    ...
    /// [`crate::jxl_encode::effort::LossyInternalParams`] and cannot be passed here.
    ///
    ...
    /// used by [`crate::jxl_encode::validation`].
    #[cfg(feature = "__expert")]
    pub(crate) fn profile_override_ref(&self) -> Option<&crate::jxl_encode::effort::EffortProfile> {
    ...
    /// let jxl = crate::jxl_encode::LosslessConfig::new()
    ///     .encode(&pixels, 100, 100, crate::jxl_encode::PixelLayout::Rgb8)?;
    /// # Ok::<_, crate::jxl_encode::At<crate::jxl_encode::EncodeError>>(())
    /// ```
    #[track_caller]
    #[inline]
...
pub struct LossyConfig {
    ...
    splines: Option<Vec<crate::jxl_encode::vardct::splines::Spline>>,
...
impl LossyConfig {
    ...
    ///
    /// Each `Some(_)` field on the supplied
    /// [`crate::jxl_encode::effort::LossyInternalParams`] overrides the corresponding
    /// effort-derived default; `None` fields keep the default. Per-knob
    ...
    /// [`crate::jxl_encode::effort::LosslessInternalParams`] and cannot be passed here.
    ///
    /// **Requires the `__expert` cargo feature.**
    /// Not stable; the underlying field set may grow additively between
    /// minor versions.
    ...
    /// ```rust,no_run
    /// # let pixels = vec![0u8; 100 * 100 * 3];
    /// let jxl = crate::jxl_encode::LossyConfig::new(1.0)
    ///     .encode(&pixels, 100, 100, crate::jxl_encode::PixelLayout::Rgb8)?;
    /// # Ok::<_, crate::jxl_encode::At<crate::jxl_encode::EncodeError>>(())
    /// ```
    #[track_caller]
...
impl<'a> EncodeRequest<'a> {
    ...
    pub fn with_color_encoding(
        mut self,
        ce: crate::jxl_encode::headers::color_encoding::ColorEncoding,
    ) -> Self {
    ...
    fn encode_inner(&self, pixels: &[u8]) -> core::result::Result<EncodeResult, EncodeError> {
        ...
        {
            crate::jxl_encode::container::wrap_in_container(&codestream, meta.exif, meta.xmp)
        } else {
            codestream
        };
    ...
    fn encode_lossless(
        ...
        use crate::jxl_encode::headers::color_encoding::ColorSpace;
        use crate::jxl_encode::headers::{ColorEncoding, FileHeader};
        use crate::jxl_encode::modular::channel::ModularImage;
        use crate::jxl_encode::modular::frame::{FrameEncoder, FrameEncoderOptions};
        ...
        let patches_data = if can_use_patches {
            crate::jxl_encode::vardct::patches::find_and_build_lossless(
                detection_pixels,
                w,
                h,
                num_channels,
        ...
        {
            crate::jxl_encode::icc::write_icc(icc, &mut writer).map_err(EncodeError::from)?;
        }
        ...
        if let Some(ref pd) = patches_data {
            ...
            crate::jxl_encode::vardct::patches::encode_reference_frame_rgb(
                pd,
                image.bit_depth,
                cfg.use_ans,
            ...
            crate::jxl_encode::vardct::patches::subtract_patches_modular(&mut image, pd, bd);
        }
    ...
    fn encode_lossy(
        ...
        let can_direct_rgb8 = self.layout == PixelLayout::Rgb8
            ...
            && self
                .color_encoding
                .as_ref()
                .is_none_or(crate::jxl_encode::headers::color_encoding::ColorEncoding::is_srgb);
...
impl LossyEncoder {
    ...
    fn finish_inner(self) -> core::result::Result<EncodeResult, EncodeError> {
        ...
        let output = if self.exif.is_some() || self.xmp.is_some() {
            crate::jxl_encode::container::wrap_in_container(
                &codestream,
                self.exif.as_deref(),
                self.xmp.as_deref(),
            )
...
pub struct LosslessEncoder {
    ...
    layout: PixelLayout,
    rows_pushed: u32,
    channels: Vec<crate::jxl_encode::modular::channel::Channel>,
...
impl LosslessConfig {
    ...
    pub fn encoder(&self, width: u32, height: u32, layout: PixelLayout) -> Result<LosslessEncoder> {
        use crate::jxl_encode::modular::channel::Channel;
    ...
    T: Send,
{
    ...
    if threads == 1 {
        return crate::jxl_encode::parallel::with_sequential_maps(f);
    }
...
fn encode_animation_lossless(
    ...
    use crate::jxl_encode::bit_writer::BitWriter;
    use crate::jxl_encode::headers::file_header::AnimationHeader;
    use crate::jxl_encode::headers::{ColorEncoding, FileHeader};
    use crate::jxl_encode::modular::channel::ModularImage;
    use crate::jxl_encode::modular::frame::{FrameEncoder, FrameEncoderOptions};
...
fn encode_animation_lossy(
    ...
    use crate::jxl_encode::bit_writer::BitWriter;
    use crate::jxl_encode::headers::file_header::AnimationHeader;
    use crate::jxl_encode::headers::frame_header::FrameOptions;
...
use crate::jxl_encode::headers::frame_header::FrameCrop;
...
fn srgb_to_linear_f(c: f32) -> f32 {
    if c <= 0.04045 {
        ...
        crate::jxl_encode_simd::fast_powf((c + 0.055) / 1.055, 2.4)
    }
}
...
fn gamma_u8_to_linear_f32(data: &[u8], channels: usize, gamma: f32) -> Vec<f32> {
    ...
    let lut: [f32; 256] =
        core::array::from_fn(|i| crate::jxl_encode_simd::fast_powf(i as f32 / 255.0, inv_gamma));
...
fn gamma_u16_to_linear_f32(data: &[u8], channels: usize, gamma: f32) -> Vec<f32> {
    ...
    pixels
        ...
        .flat_map(|px| {
            [
                crate::jxl_encode_simd::fast_powf(px[0] as f32 / 65535.0, inv_gamma),
                crate::jxl_encode_simd::fast_powf(px[1] as f32 / 65535.0, inv_gamma),
                crate::jxl_encode_simd::fast_powf(px[2] as f32 / 65535.0, inv_gamma),
            ]
        })
        .collect()
}
...
fn gamma_gray_u16_to_linear_f32_rgb(data: &[u8], stride: usize, gamma: f32) -> Vec<f32> {
    ...
    pixels
        .chunks(stride)
        .flat_map(|px| {
            let v = crate::jxl_encode_simd::fast_powf(px[0] as f32 / 65535.0, inv_gamma);
            [v, v, v]
        })
        .collect()
}
...
mod tests {
    ...
    fn test_lossy_palette_encode() {
        ...
        // Verify JXL decoder can parse and decode it
    ...
    fn test_lossy_palette_multi_group() {
        ...
        let out = crate::jxl_encode::test_helpers::output_dir("lossy_palette");
    ...
    fn test_palette_256_colors_regression() {
        ...
        use crate::jxl_encode::modular::encode::write_modular_stream_with_palette;
        ...
        let mut writer = crate::jxl_encode::bit_writer::BitWriter::new();
    ...
    mod internal_params {
        use super::*;
        use crate::jxl_encode::effort::{LosslessInternalParams, LossyInternalParams};
        ...
        fn lossless_internal_params_changes_bitstream() {
            ...
            assert_eq!(&bytes_a[..2], &crate::jxl_encode::JXL_SIGNATURE);
            assert_eq!(&bytes_b[..2], &crate::jxl_encode::JXL_SIGNATURE);
            assert_ne!(
                bytes_a, bytes_b,
        ...
        fn lossy_internal_params_changes_bitstream() {
            let mut entropy = crate::jxl_encode::effort::EntropyMulTable::reference();
            entropy.dct8 = 0.95;
