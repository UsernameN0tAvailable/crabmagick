...
use crate::jxl_encode::api::EncoderMode;
...
///
/// Apply via [`crate::jxl_encode::api::LossyConfig::with_internal_params`]. Fields are
...
///
/// Apply via [`crate::jxl_encode::api::LosslessConfig::with_internal_params`]. Fields
