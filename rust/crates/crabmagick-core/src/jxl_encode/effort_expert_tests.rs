...
//
//! Per-knob coverage for [`crate::jxl_encode::effort::LossyInternalParams`] and
//! [`crate::jxl_encode::effort::LosslessInternalParams`] — the segmented public expert
...
use crate::jxl_encode::api::{LosslessConfig, LossyConfig, PixelLayout};
use crate::jxl_encode::effort::{EntropyMulTable, LosslessInternalParams, LossyInternalParams};
...
fn assert_lossy_field_changes_output(field_name: &str, params: LossyInternalParams) {
    ...
    assert_eq!(&bytes_override[..2], &crate::jxl_encode::JXL_SIGNATURE);
    assert_eq!(&bytes_baseline[..2], &crate::jxl_encode::JXL_SIGNATURE);
    assert_ne!(
