...
use crate::jxl_encode::entropy_coding::huffman_tree::{build_and_store_huffman_tree, create_huffman_tree};
...
// LZ77 constants (from JPEG decoderxl)
...
/// This matches JXL decoder's add_log2_ceil function exactly.
#[inline]
...
pub(crate) fn write_sparse_lz77_histogram(
    ...
    crate::jxl_encode::trace::debug_eprintln!("SPARSE_HIST: Writing LZ77-enabled histogram");
    ...
    crate::jxl_encode::trace::debug_eprintln!("SPARSE_HIST: {} used symbols", _num_used);
