...
use crate::jxl_encode::JXL_SIGNATURE;
...
impl FileHeader {
    ...
    fn write_size_header(&self, writer: &mut BitWriter) -> Result<()> {
        ...
        if small {
            ...
            crate::jxl_encode::trace::debug_eprintln!("SIZE_HDR: ysize_div8_minus_1 = {}", self.height / 8 - 1);
            writer.write(5, (self.height / 8 - 1) as u64)?;

            let ratio = self.compute_ratio();
            crate::jxl_encode::trace::debug_eprintln!("SIZE_HDR: ratio = {}", ratio);
    ...
    pub fn write(&self, writer: &mut BitWriter) -> Result<()> {
        crate::jxl_encode::trace::debug_eprintln!("FHDR [bit {}]: Starting file header", writer.bits_written());
        Self::write_signature(writer)?;
        crate::jxl_encode::trace::debug_eprintln!("FHDR [bit {}]: After signature", writer.bits_written());
        self.write_size_header(writer)?;
        crate::jxl_encode::trace::debug_eprintln!("FHDR [bit {}]: After size header", writer.bits_written());
        self.write_image_metadata(writer)?;
        crate::jxl_encode::trace::debug_eprintln!("FHDR [bit {}]: After metadata", writer.bits_written());
        ...
        crate::jxl_encode::trace::debug_eprintln!("FHDR [bit {}]: After transform_data", writer.bits_written());
        Ok(())
    }
    ...
    fn write_image_metadata(&self, writer: &mut BitWriter) -> Result<()> {
        ...
        // bit_depth
        crate::jxl_encode::trace::debug_eprintln!("META [bit {}]: Writing bit_depth", writer.bits_written());
        meta.bit_depth.write(writer)?;
        crate::jxl_encode::trace::debug_eprintln!("META [bit {}]: After bit_depth", writer.bits_written());
        ...
        crate::jxl_encode::trace::debug_eprintln!("META [bit {}]: After color_encoding", writer.bits_written());
        ...
        if extra_fields {
            ...
            if !tone_all_default {
                crate::jxl_encode::f16::write_f16(meta.intensity_target, writer)?;
                crate::jxl_encode::f16::write_f16(meta.min_nits, writer)?;
                writer.write_bit(false)?; // relative_to_max_display
                crate::jxl_encode::f16::write_f16(0.0, writer)?; // linear_below
            }
        }
