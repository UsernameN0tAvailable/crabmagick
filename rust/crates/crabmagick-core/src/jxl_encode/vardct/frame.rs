    ...
    pub(crate) fn calc(
        ...
        #[cfg(feature = "parallel")]
        {
            ...
            if height >= PAR_MIN_ROWS {
                ...
                let results: Vec<(f32, f32, f32)> = crate::jxl_encode::parallel::parallel_map(n_strips, |s| {
...
fn quant_dc(distance: f32) -> f32 {
    ...
    let effective_dist = DC_MUL * crate::jxl_encode_simd::fast_powf(distance / DC_MUL, DC_QUANT_POW);
...
impl DistanceParams {
    ...
    pub fn compute_for_profile(distance: f32, profile: &crate::jxl_encode::effort::EffortProfile) -> Self {
