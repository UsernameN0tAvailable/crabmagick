...
use crate::jxl_encode::headers::color_encoding::Primaries;
...
impl XybRowScratch {
    fn new(width: usize) -> Self {
        Self {
            r: crate::jxl_encode_simd::vec_f32_dirty(width),
            g: crate::jxl_encode_simd::vec_f32_dirty(width),
            b: crate::jxl_encode_simd::vec_f32_dirty(width),
        }
    }
}
...
fn convert_rgb8_srgb_strip(
    ...
    for local_y in 0..strip_rows {
        ...
        crate::jxl_encode_simd::linear_rgb_to_xyb_batch(
            &scratch.r,
            &scratch.g,
            &scratch.b,
