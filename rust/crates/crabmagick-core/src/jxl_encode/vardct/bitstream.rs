...
use crate::jxl_encode::api::ProgressiveMode;
...
use crate::jxl_encode::headers::color_encoding::{ColorEncoding, ColorSpace, RenderingIntent};
use crate::jxl_encode::headers::extra_channels::ExtraChannelInfo;
use crate::jxl_encode::headers::file_header::{BitDepth, FileHeader, ImageMetadata};
use crate::jxl_encode::headers::frame_header::{BlendMode, FrameHeader, FrameOptions};
...
fn encode_dc_group_section(
    ...
    dc_lz77_params: Option<&crate::jxl_encode::entropy_coding::lz77::Lz77Params>,
) -> Result<Vec<u8>> {
...
fn encode_ac_group_section(
    ...
    ac_lz77_params: Option<&crate::jxl_encode::entropy_coding::lz77::Lz77Params>,
...
impl VarDctEncoder {
    ...
    pub(crate) fn write_file_header_and_pad(
        ...
        if let Some(ref icc) = self.icc_profile {
            crate::jxl_encode::icc::write_icc(icc, writer)?;
        }
    ...
    pub(crate) fn write_lz77_header(
        lz77: Option<&crate::jxl_encode::entropy_coding::lz77::Lz77Params>,
        writer: &mut BitWriter,
    ) -> Result<()> {
        crate::jxl_encode::entropy_coding::lz77::write_lz77_header(lz77, writer)
    }
    ...
    pub(crate) fn write_dc_global(
        ...
        crate::jxl_encode::f16::write_lf_quant(writer, dc_quant_custom)?;
    ...
    pub(crate) fn write_dc_group(
        ...
        ac_strategy: &AcStrategyMap,
        sharpness_map: Option<&[u8]>,
        dc_code: &crate::jxl_encode::entropy_coding::encode::EntropyCode,
        writer: &mut BitWriter,
    ) -> Result<()> {
        #[cfg(feature = "debug-tokens")]
        let start_bits = writer.bits_written();
    ...
    pub(crate) fn write_ac_group(
        ...
        ac_strategy: &AcStrategyMap,
        block_ctx_map: &BlockCtxMap,
        ac_code: &crate::jxl_encode::entropy_coding::encode::EntropyCode,
        writer: &mut BitWriter,
    ) -> Result<()> {
        #[cfg(feature = "debug-tokens")]
        let start_bits = writer.bits_written();
    ...
    fn encode_two_pass_to_writer(
        ...
        let mut dc_lz77_params: Option<crate::jxl_encode::entropy_coding::lz77::Lz77Params> = None;
        let mut ac_lz77_params_per_pass: Vec<Option<crate::jxl_encode::entropy_coding::lz77::Lz77Params>> =
            vec![None; num_passes];
        ...
        if use_lz77 {
            ...
            if let Some((lz77_tokens, params)) = crate::jxl_encode::entropy_coding::lz77::apply_lz77(
                &merged_dc,
                dc_num_ctx,
                false,
                self.lz77_method,
                ...
                for i in 0..num_dc_groups {
                    ...
                    if let Some((lz77_dc, _)) = crate::jxl_encode::entropy_coding::lz77::apply_lz77(
                    ...
                    if let Some((lz77_md, _)) = crate::jxl_encode::entropy_coding::lz77::apply_lz77(
            ...
            for pass in 0..num_passes {
                ...
                if let Some((_lz77_tokens, params)) = crate::jxl_encode::entropy_coding::lz77::apply_lz77(
                    &merged_ac,
                    ac_num_ctx,
                    false,
                    self.lz77_method,
                    ...
                    for tokens in &scratch.ac_section_tokens_per_pass[pass] {
                        if let Some((lz77_ac, _)) = crate::jxl_encode::entropy_coding::lz77::apply_lz77(
                            tokens,
                            ac_num_ctx,
                            false,
                            self.lz77_method,
        ...
        #[cfg(feature = "parallel")]
        let built_codes = if !crate::jxl_encode::parallel::sequential_maps_forced() {
            crate::jxl_encode::parallel::parallel_map(num_entropy_code_jobs, |job_idx| {
                crate::jxl_encode::parallel::with_sequential_maps(|| build_entropy_code_job(job_idx))
            })
        } else {
        ...
        // Write frame header
        {
            ...
            if noise_params.is_some() {
                fh.flags |= crate::jxl_encode::headers::frame_header::ENABLE_NOISE;
            }
            if patches.is_some() {
                fh.flags |= crate::jxl_encode::headers::frame_header::PATCHES_FLAG;
            }
            if splines.is_some() {
                fh.flags |= crate::jxl_encode::headers::frame_header::SPLINES_FLAG;
            }
            if self.use_lf_frame {
                fh.flags |= crate::jxl_encode::headers::frame_header::USE_LF_FRAME;
            }
        ...
        if num_groups == 1 && num_dc_groups == 1 && num_passes == 1 {
            ...
            if crate::jxl_encode::parallel::sequential_maps_forced() {
                ...
                let dc_group_sections: Vec<Vec<u8>> =
                    crate::jxl_encode::parallel::parallel_map_result(num_dc_groups, encode_dc_group)?;
            ...
            for pass in 0..num_passes {
                ...
                if crate::jxl_encode::parallel::sequential_maps_forced() {
                    ...
                    let ac_group_sections: Vec<Vec<u8>> =
                        crate::jxl_encode::parallel::parallel_map_result(num_groups, encode_ac_group)?;
    ...
    fn write_modular_alpha_subbitstream(
        ...
        use crate::jxl_encode::modular::encode::{
        ...
        use crate::jxl_encode::modular::predictor::pack_signed;
