...
pub fn compute_mask1x1(xyb_y: &[f32], width: usize, height: usize) -> Vec<f32> {
    ...
    crate::jxl_encode_simd::compute_mask1x1(xyb_y, width, height, &mut mask1x1);
...
// symmetric5_blur_mask1x1 replaced by crate::jxl_encode_simd::gaborish_5x5_channel with
...
fn per_block_modulations(
    ...
    crate::jxl_encode_simd::per_block_modulations(
        xyb_x,
        xyb_y,
        xyb_b,
        stride,
...
mod tests {
    ...
    // compute_mask) migrated to crate::jxl_encode_simd::adaptive_quant::tests.
