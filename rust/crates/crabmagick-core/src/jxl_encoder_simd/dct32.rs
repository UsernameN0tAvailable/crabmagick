...
pub(crate) fn dct1d_32_batch(token: archmage::X64V3Token, v: &mut [magetypes::simd::f32x8; 32]) {
    ...
    crate::jxl_encoder_simd::dct16::dct1d_16_batch(token, &mut a);
    ...
    crate::jxl_encoder_simd::dct16::dct1d_16_batch(token, &mut s);
...
pub fn dct_32x16_avx2(token: archmage::X64V3Token, input: &[f32; 512], output: &mut [f32; 512]) {
    ...
    for batch in 0..4 {
        ...
        crate::jxl_encoder_simd::dct16::dct1d_16_batch(token, &mut v);
        for j in 0..16 {
            v[j] *= inv16;
        }
        for j in 0..16 {
