...
pub fn idct_32x32_scalar(input: &[f32; 1024], output: &mut [f32; 1024]) {
    let mut tmp = crate::jxl_encoder_simd::scratch_buf::<1024>();
    ...
    // Transpose 32×32
    let mut transposed = crate::jxl_encoder_simd::scratch_buf::<1024>();
    for r in 0..32 {
        for c in 0..32 {
...
pub fn idct_32x16_scalar(input: &[f32; 512], output: &mut [f32; 512]) {
    let mut tmp = crate::jxl_encoder_simd::scratch_buf::<512>();
    ...
    let mut transposed = crate::jxl_encoder_simd::scratch_buf::<512>();
    for r in 0..16 {
        for c in 0..32 {
...
pub fn idct_16x32_scalar(input: &[f32; 512], output: &mut [f32; 512]) {
    ...
    let mut transposed2 = crate::jxl_encoder_simd::scratch_buf::<512>();
    for r in 0..32 {
        for c in 0..16 {
...
pub(crate) fn idct1d_32_core_batch(
    ...
    crate::jxl_encoder_simd::idct16::idct1d_16_core_batch(token, &mut second);
    ...
    crate::jxl_encoder_simd::idct16::idct1d_16_core_batch(token, &mut first);
...
pub fn idct_32x16_avx2(token: archmage::X64V3Token, input: &[f32; 512], output: &mut [f32; 512]) {
    ...
    for batch in 0..4 {
        ...
        crate::jxl_encoder_simd::idct16::idct1d_16_batch(token, &mut v);
        for j in 0..16 {
...
mod tests {
    ...
    fn test_dct32_idct32_roundtrip() {
        ...
        crate::jxl_encoder_simd::dct32::dct_32x32(&input, &mut coeffs);
    ...
    fn test_dct32x16_idct32x16_roundtrip() {
        ...
        crate::jxl_encoder_simd::dct32::dct_32x16(&input, &mut coeffs);
    ...
    fn test_dct16x32_idct16x32_roundtrip() {
        ...
        let mut coeffs = [0.0f32; 512];
        crate::jxl_encoder_simd::dct32::dct_16x32(&input, &mut coeffs);
