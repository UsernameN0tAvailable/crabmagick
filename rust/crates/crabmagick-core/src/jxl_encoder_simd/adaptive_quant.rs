...
pub fn compute_pre_erosion_avx2(
    ...
    for y in y_start..y_end {
        ...
        while local_x < simd_end {
            ...
            let top = crate::jxl_encoder_simd::load_f32x8(token, xyb_y, y1 * width + xc);
            let bot = crate::jxl_encoder_simd::load_f32x8(token, xyb_y, y2 * width + xc);
            let left = crate::jxl_encoder_simd::load_f32x8(token, xyb_y, yc * width + xc - 1);
            let right = crate::jxl_encoder_simd::load_f32x8(token, xyb_y, yc * width + xc + 1);
            let center = crate::jxl_encoder_simd::load_f32x8(token, xyb_y, yc * width + xc);
    ...
    for iy in 0..rect_h_blocks {
        ...
        for ix in 0..rect_w_blocks {
            ...
            for dy in 0..8 {
                ...
                let y_vals = crate::jxl_encoder_simd::load_f32x8(token, xyb_y, row_off);
                let x_vals = crate::jxl_encoder_simd::load_f32x8(token, xyb_x, row_off);
            ...
            for dy in 0..8 {
                ...
                let cur = crate::jxl_encoder_simd::load_f32x8(token, xyb_y, row_off);
                let below = crate::jxl_encoder_simd::load_f32x8(token, xyb_y, next_row_off);
            ...
            for dy in 0..8 {
                ...
                let x_vals = crate::jxl_encoder_simd::load_f32x8(token, xyb_x, row_off);
                let y_vals = crate::jxl_encoder_simd::load_f32x8(token, xyb_y, row_off);
                let b_vals = crate::jxl_encoder_simd::load_f32x8(token, xyb_b, row_off);
