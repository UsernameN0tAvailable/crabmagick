...
//! handling in memory buffers by using [`ZCursor`](crate::zune_core::bytestream::ZCursor).
//!
...
//!
//! If you have an in memory buffer, use [`ZCursor`](crate::zune_core::bytestream::ZCursor),
