...
use crate::zune_core::bytestream::ZByteIoError;

use crate::zune_jpeg::misc::{
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> core::fmt::Result {
        match &self
        {
            ...
            Self::LargeDimensions(dimensions) => write!(
                f,
                "Too large dimensions {dimensions},library supports up to {}", crate::zune_jpeg::decoder::MAX_DIMENSIONS
            ),
