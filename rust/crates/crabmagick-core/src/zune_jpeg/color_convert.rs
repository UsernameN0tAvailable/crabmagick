...
pub use crate::zune_jpeg::color_convert::avx::{ycbcr_to_rgb_avx2, ycbcr_to_rgba_avx2};
use crate::zune_jpeg::decoder::ColorConvert16Ptr;
...
pub fn choose_ycbcr_to_rgb_convert_func(
    ...
    {
        if options.use_neon() {
            use crate::zune_jpeg::color_convert::neon64::{ycbcr_to_rgb_neon, ycbcr_to_rgba_neon};
            match type_need {
